...
class VercelPagingFeature extends VercelBaseFeature
{
    ...
    private function _graphql_pre_request(VercelContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(VercelContext $ctx): bool
    {
