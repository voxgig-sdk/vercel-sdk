...
// Vercel SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = VercelOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(VercelOmni::structfix($now, Struct::undef()))
                        !== json_encode(VercelOmni::structfix($val, Struct::undef()))) {
