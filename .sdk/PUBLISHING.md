...
|---|---|---|
| `js/` | @voxgig-sdk/vercel-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/vercel | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/vercel-js \
      --repository voxgig-sdk/vercel-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/vercel-js` shows it, and
`npm trust revoke @voxgig-sdk/vercel-js --id=<id>` removes it.
