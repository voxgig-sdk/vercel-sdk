...
const testSeed = `map[string]any{"entity": map[string]any{"access_group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_gateway": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_gateway_rule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_gateway_rule_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_gateway_virtual_model_config": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "ai_gateway_virtual_model_config_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "alias": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_ai_gateway": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "api_key": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "artifact": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "authentication": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "billing": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bulk_redirect": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cert": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "check": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "checks_v2": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connect": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connect_connector": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connect_connector_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connect_connector_project_connection_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connect_project_connection": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "connect_project_connector_connection_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "deployment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dns": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "domains_registrar": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "drain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "edge_cache": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "env": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "environment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "feature_flag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "file": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "flag": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "flags_sdk_key_with_secret": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "global_config": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "global_config_item": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "global_config_token": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "integration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "kms": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "list_event_type": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "log": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "log_drain": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "marketplace": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "microfrontend": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "network": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "networking": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "observability": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "private_link_endpoint": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project_member": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "project_route": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "query": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "record": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "rolling_release": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "sandbox": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schema": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "security": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "segment": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "storage": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "team": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tld_name": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "toggle": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vcr": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vcr_image_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vcr_repository_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "vcr_repository_permission_list": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "web_analytics": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
