...
func TestSegmentEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_SEGMENT_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func segmentBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"segment01", "segment02", "segment03", "project01", "project02", "project03"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("VERCEL_TEST_SEGMENT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["VERCEL_TEST_SEGMENT_ENTID"])
