...
func TestApiKeyEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_API_KEY_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func api_keyBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("VERCEL_TEST_API_KEY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["VERCEL_TEST_API_KEY_ENTID"])
