...
func TestLogEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_LOG_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func logBasicSetup(extra map[string]any) *entityTestSetup {
	...
	idmap, _ := vs.Transform(
		[]any{"log01", "log02", "log03", "project01", "project02", "project03", "deployment01", "deployment02", "deployment03"},
		map[string]any{
	...
	entidEnvRaw := os.Getenv("VERCEL_TEST_LOG_ENTID")
	...
	idmapResolved := core.ToMapAny(env["VERCEL_TEST_LOG_ENTID"])
