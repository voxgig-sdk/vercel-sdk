...
func NewVcrEntity(client *core.VercelSDK, entopts map[string]any) *VcrEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VcrEntity) GetName() string { return e.name }
...
func (e *VcrEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VcrEntity) Deleted() bool {
	return e.deleted
}


func (e *VcrEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVcrEntity(e.client, opts)
}

func (e *VcrEntity) Data(args ...any) any {
...
func (e *VcrEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Vcr; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VcrEntity) DataTyped(data ...Vcr) Vcr {
	if len(data) > 0 {
		return typedFrom[Vcr](e.Data(asMap(data[0])))
	}
	return typedFrom[Vcr](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Vcr (all fields
// optional at the wire level).
func (e *VcrEntity) MatchTyped(match ...Vcr) Vcr {
	if len(match) > 0 {
		return typedFrom[Vcr](e.Match(asMap(match[0])))
	}
	return typedFrom[Vcr](e.Match())
}
...
func (e *VcrEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VcrEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VcrLoadMatch and returns an Vcr. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *VcrEntity) LoadTyped(reqmatch VcrLoadMatch, ctrl map[string]any) (Vcr, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Vcr{}, err
	}
	return typedFrom[Vcr](res), nil
}




func (e *VcrEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// VcrListMatch and returns []Vcr. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VcrEntity) ListTyped(reqmatch VcrListMatch, ctrl map[string]any) ([]Vcr, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Vcr](res), nil
}




func (e *VcrEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// VcrCreateData and returns an Vcr. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *VcrEntity) CreateTyped(reqdata VcrCreateData, ctrl map[string]any) (Vcr, error) {
...
func (e *VcrEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// VcrUpdateData and returns an Vcr. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *VcrEntity) UpdateTyped(reqdata VcrUpdateData, ctrl map[string]any) (Vcr, error) {
...
func (e *VcrEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// VcrRemoveMatch and returns an Vcr. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *VcrEntity) RemoveTyped(reqmatch VcrRemoveMatch, ctrl map[string]any) (Vcr, error) {
...
func (e *VcrEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
