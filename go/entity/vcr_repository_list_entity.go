...
type VcrRepositoryListEntity struct {
	name    string
...
func NewVcrRepositoryListEntity(client *core.VercelSDK, entopts map[string]any) *VcrRepositoryListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &VcrRepositoryListEntity{
		name:    "vcr_repository_list",
		client:  client,
...
func (e *VcrRepositoryListEntity) GetName() string { return e.name }
...
func (e *VcrRepositoryListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VcrRepositoryListEntity) Deleted() bool {
	return e.deleted
}


func (e *VcrRepositoryListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVcrRepositoryListEntity(e.client, opts)
}

func (e *VcrRepositoryListEntity) Data(args ...any) any {
...
func (e *VcrRepositoryListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an VcrRepositoryList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VcrRepositoryListEntity) DataTyped(data ...VcrRepositoryList) VcrRepositoryList {
	if len(data) > 0 {
		return typedFrom[VcrRepositoryList](e.Data(asMap(data[0])))
	}
	return typedFrom[VcrRepositoryList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through VcrRepositoryList (all fields
// optional at the wire level).
func (e *VcrRepositoryListEntity) MatchTyped(match ...VcrRepositoryList) VcrRepositoryList {
	if len(match) > 0 {
		return typedFrom[VcrRepositoryList](e.Match(asMap(match[0])))
	}
	return typedFrom[VcrRepositoryList](e.Match())
}
...
func (e *VcrRepositoryListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VcrRepositoryListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *VcrRepositoryListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VcrRepositoryListListMatch and returns []VcrRepositoryList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VcrRepositoryListEntity) ListTyped(reqmatch VcrRepositoryListListMatch, ctrl map[string]any) ([]VcrRepositoryList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[VcrRepositoryList](res), nil
}



func (e *VcrRepositoryListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VcrRepositoryListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VcrRepositoryListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VcrRepositoryListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
