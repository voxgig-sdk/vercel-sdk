...
func NewStorageEntity(client *core.VercelSDK, entopts map[string]any) *StorageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StorageEntity) GetName() string { return e.name }
...
func (e *StorageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StorageEntity) Deleted() bool {
	return e.deleted
}


func (e *StorageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStorageEntity(e.client, opts)
}

func (e *StorageEntity) Data(args ...any) any {
...
func (e *StorageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Storage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StorageEntity) DataTyped(data ...Storage) Storage {
	if len(data) > 0 {
		return typedFrom[Storage](e.Data(asMap(data[0])))
	}
	return typedFrom[Storage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Storage (all fields
// optional at the wire level).
func (e *StorageEntity) MatchTyped(match ...Storage) Storage {
	if len(match) > 0 {
		return typedFrom[Storage](e.Match(asMap(match[0])))
	}
	return typedFrom[Storage](e.Match())
}
...
func (e *StorageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StorageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StorageLoadMatch and returns an Storage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StorageEntity) LoadTyped(reqmatch StorageLoadMatch, ctrl map[string]any) (Storage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Storage{}, err
	}
	return typedFrom[Storage](res), nil
}



func (e *StorageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *StorageEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// StorageCreateData and returns an Storage. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *StorageEntity) CreateTyped(reqdata StorageCreateData, ctrl map[string]any) (Storage, error) {
...
func (e *StorageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *StorageEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// StorageRemoveMatch and returns an Storage. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *StorageEntity) RemoveTyped(reqmatch StorageRemoveMatch, ctrl map[string]any) (Storage, error) {
...
func (e *StorageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
