...
type ListEventTypeEntity struct {
	name    string
...
func NewListEventTypeEntity(client *core.VercelSDK, entopts map[string]any) *ListEventTypeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ListEventTypeEntity) GetName() string { return e.name }
...
func (e *ListEventTypeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ListEventTypeEntity) Deleted() bool {
	return e.deleted
}


func (e *ListEventTypeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewListEventTypeEntity(e.client, opts)
}

func (e *ListEventTypeEntity) Data(args ...any) any {
...
func (e *ListEventTypeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ListEventType; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ListEventTypeEntity) DataTyped(data ...ListEventType) ListEventType {
	if len(data) > 0 {
		return typedFrom[ListEventType](e.Data(asMap(data[0])))
	}
	return typedFrom[ListEventType](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ListEventType (all fields
// optional at the wire level).
func (e *ListEventTypeEntity) MatchTyped(match ...ListEventType) ListEventType {
	if len(match) > 0 {
		return typedFrom[ListEventType](e.Match(asMap(match[0])))
	}
	return typedFrom[ListEventType](e.Match())
}
...
func (e *ListEventTypeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ListEventTypeEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ListEventTypeEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ListEventTypeListMatch and returns []ListEventType. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ListEventTypeEntity) ListTyped(reqmatch ListEventTypeListMatch, ctrl map[string]any) ([]ListEventType, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[ListEventType](res), nil
}



func (e *ListEventTypeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ListEventTypeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ListEventTypeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ListEventTypeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
