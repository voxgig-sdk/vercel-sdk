...
func NewConnectEntity(client *core.VercelSDK, entopts map[string]any) *ConnectEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConnectEntity) GetName() string { return e.name }
...
func (e *ConnectEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConnectEntity) Deleted() bool {
	return e.deleted
}


func (e *ConnectEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConnectEntity(e.client, opts)
}

func (e *ConnectEntity) Data(args ...any) any {
...
func (e *ConnectEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Connect; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConnectEntity) DataTyped(data ...Connect) Connect {
	if len(data) > 0 {
		return typedFrom[Connect](e.Data(asMap(data[0])))
	}
	return typedFrom[Connect](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Connect (all fields
// optional at the wire level).
func (e *ConnectEntity) MatchTyped(match ...Connect) Connect {
	if len(match) > 0 {
		return typedFrom[Connect](e.Match(asMap(match[0])))
	}
	return typedFrom[Connect](e.Match())
}
...
func (e *ConnectEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConnectEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ConnectEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ConnectEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConnectCreateData and returns an Connect. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ConnectEntity) CreateTyped(reqdata ConnectCreateData, ctrl map[string]any) (Connect, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Connect{}, err
	}
	return typedFrom[Connect](res), nil
}



func (e *ConnectEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ConnectEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ConnectRemoveMatch and returns an Connect. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ConnectEntity) RemoveTyped(reqmatch ConnectRemoveMatch, ctrl map[string]any) (Connect, error) {
...
func (e *ConnectEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
