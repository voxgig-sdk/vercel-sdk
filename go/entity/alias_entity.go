...
func NewAliasEntity(client *core.VercelSDK, entopts map[string]any) *AliasEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AliasEntity) GetName() string { return e.name }
...
func (e *AliasEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AliasEntity) Deleted() bool {
	return e.deleted
}


func (e *AliasEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAliasEntity(e.client, opts)
}

func (e *AliasEntity) Data(args ...any) any {
...
func (e *AliasEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Alias; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AliasEntity) DataTyped(data ...Alias) Alias {
	if len(data) > 0 {
		return typedFrom[Alias](e.Data(asMap(data[0])))
	}
	return typedFrom[Alias](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Alias (all fields
// optional at the wire level).
func (e *AliasEntity) MatchTyped(match ...Alias) Alias {
	if len(match) > 0 {
		return typedFrom[Alias](e.Match(asMap(match[0])))
	}
	return typedFrom[Alias](e.Match())
}
...
func (e *AliasEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AliasEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AliasLoadMatch and returns an Alias. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AliasEntity) LoadTyped(reqmatch AliasLoadMatch, ctrl map[string]any) (Alias, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Alias{}, err
	}
	return typedFrom[Alias](res), nil
}




func (e *AliasEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AliasListMatch and returns []Alias. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AliasEntity) ListTyped(reqmatch AliasListMatch, ctrl map[string]any) ([]Alias, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Alias](res), nil
}




func (e *AliasEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// AliasCreateData and returns an Alias. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *AliasEntity) CreateTyped(reqdata AliasCreateData, ctrl map[string]any) (Alias, error) {
...
func (e *AliasEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// AliasUpdateData and returns an Alias. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *AliasEntity) UpdateTyped(reqdata AliasUpdateData, ctrl map[string]any) (Alias, error) {
...
func (e *AliasEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// AliasRemoveMatch and returns an Alias. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AliasEntity) RemoveTyped(reqmatch AliasRemoveMatch, ctrl map[string]any) (Alias, error) {
...
func (e *AliasEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
