...
func NewRecordEntity(client *core.VercelSDK, entopts map[string]any) *RecordEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RecordEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RecordLoadMatch and returns an Record. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RecordEntity) LoadTyped(reqmatch RecordLoadMatch, ctrl map[string]any) (Record, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Record{}, err
	}
	return typedFrom[Record](res), nil
}



func (e *RecordEntity) List(_ map[string]any, _ map[string]any) (any, error) {
