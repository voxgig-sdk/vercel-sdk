...
type AiGatewayRuleListEntity struct {
	name    string
...
func NewAiGatewayRuleListEntity(client *core.VercelSDK, entopts map[string]any) *AiGatewayRuleListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
	...
	e := &AiGatewayRuleListEntity{
		name:    "ai_gateway_rule_list",
		client:  client,
...
func (e *AiGatewayRuleListEntity) GetName() string { return e.name }
...
func (e *AiGatewayRuleListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiGatewayRuleListEntity) Deleted() bool {
	return e.deleted
}


func (e *AiGatewayRuleListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiGatewayRuleListEntity(e.client, opts)
}

func (e *AiGatewayRuleListEntity) Data(args ...any) any {
...
func (e *AiGatewayRuleListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiGatewayRuleList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiGatewayRuleListEntity) DataTyped(data ...AiGatewayRuleList) AiGatewayRuleList {
	if len(data) > 0 {
		return typedFrom[AiGatewayRuleList](e.Data(asMap(data[0])))
	}
	return typedFrom[AiGatewayRuleList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiGatewayRuleList (all fields
// optional at the wire level).
func (e *AiGatewayRuleListEntity) MatchTyped(match ...AiGatewayRuleList) AiGatewayRuleList {
	if len(match) > 0 {
		return typedFrom[AiGatewayRuleList](e.Match(asMap(match[0])))
	}
	return typedFrom[AiGatewayRuleList](e.Match())
}
...
func (e *AiGatewayRuleListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiGatewayRuleListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *AiGatewayRuleListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiGatewayRuleListListMatch and returns []AiGatewayRuleList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AiGatewayRuleListEntity) ListTyped(reqmatch AiGatewayRuleListListMatch, ctrl map[string]any) ([]AiGatewayRuleList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[AiGatewayRuleList](res), nil
}



func (e *AiGatewayRuleListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AiGatewayRuleListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AiGatewayRuleListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AiGatewayRuleListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
