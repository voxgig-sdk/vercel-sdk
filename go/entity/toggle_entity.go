...
func NewToggleEntity(client *core.VercelSDK, entopts map[string]any) *ToggleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ToggleEntity) GetName() string { return e.name }
...
func (e *ToggleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ToggleEntity) Deleted() bool {
	return e.deleted
}


func (e *ToggleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewToggleEntity(e.client, opts)
}

func (e *ToggleEntity) Data(args ...any) any {
...
func (e *ToggleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Toggle; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ToggleEntity) DataTyped(data ...Toggle) Toggle {
	if len(data) > 0 {
		return typedFrom[Toggle](e.Data(asMap(data[0])))
	}
	return typedFrom[Toggle](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Toggle (all fields
// optional at the wire level).
func (e *ToggleEntity) MatchTyped(match ...Toggle) Toggle {
	if len(match) > 0 {
		return typedFrom[Toggle](e.Match(asMap(match[0])))
	}
	return typedFrom[Toggle](e.Match())
}
...
func (e *ToggleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ToggleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ToggleEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ToggleEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ToggleCreateData and returns an Toggle. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ToggleEntity) CreateTyped(reqdata ToggleCreateData, ctrl map[string]any) (Toggle, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Toggle{}, err
	}
	return typedFrom[Toggle](res), nil
}



func (e *ToggleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ToggleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ToggleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
