...
func NewDrainEntity(client *core.VercelSDK, entopts map[string]any) *DrainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DrainEntity) GetName() string { return e.name }
...
func (e *DrainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DrainEntity) Deleted() bool {
	return e.deleted
}


func (e *DrainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDrainEntity(e.client, opts)
}

func (e *DrainEntity) Data(args ...any) any {
...
func (e *DrainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Drain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *DrainEntity) DataTyped(data ...Drain) Drain {
	if len(data) > 0 {
		return typedFrom[Drain](e.Data(asMap(data[0])))
	}
	return typedFrom[Drain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Drain (all fields
// optional at the wire level).
func (e *DrainEntity) MatchTyped(match ...Drain) Drain {
	if len(match) > 0 {
		return typedFrom[Drain](e.Match(asMap(match[0])))
	}
	return typedFrom[Drain](e.Match())
}
...
func (e *DrainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DrainEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// DrainLoadMatch and returns an Drain. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *DrainEntity) LoadTyped(reqmatch DrainLoadMatch, ctrl map[string]any) (Drain, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Drain{}, err
	}
	return typedFrom[Drain](res), nil
}



func (e *DrainEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *DrainEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DrainCreateData and returns an Drain. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DrainEntity) CreateTyped(reqdata DrainCreateData, ctrl map[string]any) (Drain, error) {
...
func (e *DrainEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// DrainUpdateData and returns an Drain. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *DrainEntity) UpdateTyped(reqdata DrainUpdateData, ctrl map[string]any) (Drain, error) {
...
func (e *DrainEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// DrainRemoveMatch and returns an Drain. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DrainEntity) RemoveTyped(reqmatch DrainRemoveMatch, ctrl map[string]any) (Drain, error) {
...
func (e *DrainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
