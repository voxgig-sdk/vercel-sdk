...
func NewEnvEntity(client *core.VercelSDK, entopts map[string]any) *EnvEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EnvEntity) GetName() string { return e.name }
...
func (e *EnvEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EnvEntity) Deleted() bool {
	return e.deleted
}


func (e *EnvEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEnvEntity(e.client, opts)
}

func (e *EnvEntity) Data(args ...any) any {
...
func (e *EnvEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Env; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EnvEntity) DataTyped(data ...Env) Env {
	if len(data) > 0 {
		return typedFrom[Env](e.Data(asMap(data[0])))
	}
	return typedFrom[Env](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Env (all fields
// optional at the wire level).
func (e *EnvEntity) MatchTyped(match ...Env) Env {
	if len(match) > 0 {
		return typedFrom[Env](e.Match(asMap(match[0])))
	}
	return typedFrom[Env](e.Match())
}
...
func (e *EnvEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EnvEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EnvLoadMatch and returns an Env. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EnvEntity) LoadTyped(reqmatch EnvLoadMatch, ctrl map[string]any) (Env, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Env{}, err
	}
	return typedFrom[Env](res), nil
}




func (e *EnvEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// EnvListMatch and returns []Env. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *EnvEntity) ListTyped(reqmatch EnvListMatch, ctrl map[string]any) ([]Env, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Env](res), nil
}




func (e *EnvEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EnvCreateData and returns an Env. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EnvEntity) CreateTyped(reqdata EnvCreateData, ctrl map[string]any) (Env, error) {
...
func (e *EnvEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// EnvUpdateData and returns an Env. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *EnvEntity) UpdateTyped(reqdata EnvUpdateData, ctrl map[string]any) (Env, error) {
...
func (e *EnvEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// EnvRemoveMatch and returns an Env. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *EnvEntity) RemoveTyped(reqmatch EnvRemoveMatch, ctrl map[string]any) (Env, error) {
...
func (e *EnvEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
