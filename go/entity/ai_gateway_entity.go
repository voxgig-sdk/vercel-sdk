...
func NewAiGatewayEntity(client *core.VercelSDK, entopts map[string]any) *AiGatewayEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AiGatewayEntity) GetName() string { return e.name }
...
func (e *AiGatewayEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AiGatewayEntity) Deleted() bool {
	return e.deleted
}


func (e *AiGatewayEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAiGatewayEntity(e.client, opts)
}

func (e *AiGatewayEntity) Data(args ...any) any {
...
func (e *AiGatewayEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an AiGateway; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AiGatewayEntity) DataTyped(data ...AiGateway) AiGateway {
	if len(data) > 0 {
		return typedFrom[AiGateway](e.Data(asMap(data[0])))
	}
	return typedFrom[AiGateway](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through AiGateway (all fields
// optional at the wire level).
func (e *AiGatewayEntity) MatchTyped(match ...AiGateway) AiGateway {
	if len(match) > 0 {
		return typedFrom[AiGateway](e.Match(asMap(match[0])))
	}
	return typedFrom[AiGateway](e.Match())
}
...
func (e *AiGatewayEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AiGatewayEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *AiGatewayEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *AiGatewayEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AiGatewayEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *AiGatewayEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AiGatewayRemoveMatch and returns an AiGateway. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *AiGatewayEntity) RemoveTyped(reqmatch AiGatewayRemoveMatch, ctrl map[string]any) (AiGateway, error) {
	res, err := e.Remove(asMap(reqmatch), ctrl)
	if err != nil {
		return AiGateway{}, err
	}
	return typedFrom[AiGateway](res), nil
}



func (e *AiGatewayEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
