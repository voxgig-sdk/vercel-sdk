...
func NewBillingEntity(client *core.VercelSDK, entopts map[string]any) *BillingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BillingEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// BillingCreateData and returns an Billing. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *BillingEntity) CreateTyped(reqdata BillingCreateData, ctrl map[string]any) (Billing, error) {
