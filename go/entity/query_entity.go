...
func NewQueryEntity(client *core.VercelSDK, entopts map[string]any) *QueryEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *QueryEntity) GetName() string { return e.name }
...
func (e *QueryEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *QueryEntity) Deleted() bool {
	return e.deleted
}


func (e *QueryEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewQueryEntity(e.client, opts)
}

func (e *QueryEntity) Data(args ...any) any {
...
func (e *QueryEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Query; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *QueryEntity) DataTyped(data ...Query) Query {
	if len(data) > 0 {
		return typedFrom[Query](e.Data(asMap(data[0])))
	}
	return typedFrom[Query](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Query (all fields
// optional at the wire level).
func (e *QueryEntity) MatchTyped(match ...Query) Query {
	if len(match) > 0 {
		return typedFrom[Query](e.Match(asMap(match[0])))
	}
	return typedFrom[Query](e.Match())
}
...
func (e *QueryEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *QueryEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *QueryEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *QueryEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// QueryCreateData and returns an Query. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *QueryEntity) CreateTyped(reqdata QueryCreateData, ctrl map[string]any) (Query, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Query{}, err
	}
	return typedFrom[Query](res), nil
}



func (e *QueryEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *QueryEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *QueryEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
