...
func NewCertEntity(client *core.VercelSDK, entopts map[string]any) *CertEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CertEntity) GetName() string { return e.name }
...
func (e *CertEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CertEntity) Deleted() bool {
	return e.deleted
}


func (e *CertEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCertEntity(e.client, opts)
}

func (e *CertEntity) Data(args ...any) any {
...
func (e *CertEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cert; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CertEntity) DataTyped(data ...Cert) Cert {
	if len(data) > 0 {
		return typedFrom[Cert](e.Data(asMap(data[0])))
	}
	return typedFrom[Cert](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cert (all fields
// optional at the wire level).
func (e *CertEntity) MatchTyped(match ...Cert) Cert {
	if len(match) > 0 {
		return typedFrom[Cert](e.Match(asMap(match[0])))
	}
	return typedFrom[Cert](e.Match())
}
...
func (e *CertEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CertEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CertLoadMatch and returns an Cert. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CertEntity) LoadTyped(reqmatch CertLoadMatch, ctrl map[string]any) (Cert, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cert{}, err
	}
	return typedFrom[Cert](res), nil
}




func (e *CertEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// CertListMatch and returns []Cert. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CertEntity) ListTyped(reqmatch CertListMatch, ctrl map[string]any) ([]Cert, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cert](res), nil
}




func (e *CertEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// CertCreateData and returns an Cert. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *CertEntity) CreateTyped(reqdata CertCreateData, ctrl map[string]any) (Cert, error) {
...
func (e *CertEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// CertUpdateData and returns an Cert. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *CertEntity) UpdateTyped(reqdata CertUpdateData, ctrl map[string]any) (Cert, error) {
...
func (e *CertEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// CertRemoveMatch and returns an Cert. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *CertEntity) RemoveTyped(reqmatch CertRemoveMatch, ctrl map[string]any) (Cert, error) {
...
func (e *CertEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
