...
func NewDnsEntity(client *core.VercelSDK, entopts map[string]any) *DnsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DnsEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// DnsCreateData and returns an Dns. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *DnsEntity) CreateTyped(reqdata DnsCreateData, ctrl map[string]any) (Dns, error) {
...
func (e *DnsEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// DnsUpdateData and returns an Dns. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *DnsEntity) UpdateTyped(reqdata DnsUpdateData, ctrl map[string]any) (Dns, error) {
...
func (e *DnsEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// DnsRemoveMatch and returns an Dns. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *DnsEntity) RemoveTyped(reqmatch DnsRemoveMatch, ctrl map[string]any) (Dns, error) {
