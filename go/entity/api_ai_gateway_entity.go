...
type ApiAiGatewayEntity struct {
	name    string
...
func NewApiAiGatewayEntity(client *core.VercelSDK, entopts map[string]any) *ApiAiGatewayEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ApiAiGatewayEntity) GetName() string { return e.name }
...
func (e *ApiAiGatewayEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ApiAiGatewayEntity) Deleted() bool {
	return e.deleted
}


func (e *ApiAiGatewayEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewApiAiGatewayEntity(e.client, opts)
}

func (e *ApiAiGatewayEntity) Data(args ...any) any {
...
func (e *ApiAiGatewayEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ApiAiGateway; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ApiAiGatewayEntity) DataTyped(data ...ApiAiGateway) ApiAiGateway {
	if len(data) > 0 {
		return typedFrom[ApiAiGateway](e.Data(asMap(data[0])))
	}
	return typedFrom[ApiAiGateway](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ApiAiGateway (all fields
// optional at the wire level).
func (e *ApiAiGatewayEntity) MatchTyped(match ...ApiAiGateway) ApiAiGateway {
	if len(match) > 0 {
		return typedFrom[ApiAiGateway](e.Match(asMap(match[0])))
	}
	return typedFrom[ApiAiGateway](e.Match())
}
...
func (e *ApiAiGatewayEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ApiAiGatewayEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ApiAiGatewayLoadMatch and returns an ApiAiGateway. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ApiAiGatewayEntity) LoadTyped(reqmatch ApiAiGatewayLoadMatch, ctrl map[string]any) (ApiAiGateway, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ApiAiGateway{}, err
	}
	return typedFrom[ApiAiGateway](res), nil
}



func (e *ApiAiGatewayEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ApiAiGatewayEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ApiAiGatewayEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ApiAiGatewayEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ApiAiGatewayRemoveMatch and returns an ApiAiGateway. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ApiAiGatewayEntity) RemoveTyped(reqmatch ApiAiGatewayRemoveMatch, ctrl map[string]any) (ApiAiGateway, error) {
...
func (e *ApiAiGatewayEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
