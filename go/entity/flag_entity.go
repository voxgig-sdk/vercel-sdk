...
func NewFlagEntity(client *core.VercelSDK, entopts map[string]any) *FlagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FlagEntity) GetName() string { return e.name }
...
func (e *FlagEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FlagEntity) Deleted() bool {
	return e.deleted
}


func (e *FlagEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFlagEntity(e.client, opts)
}

func (e *FlagEntity) Data(args ...any) any {
...
func (e *FlagEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Flag; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FlagEntity) DataTyped(data ...Flag) Flag {
	if len(data) > 0 {
		return typedFrom[Flag](e.Data(asMap(data[0])))
	}
	return typedFrom[Flag](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Flag (all fields
// optional at the wire level).
func (e *FlagEntity) MatchTyped(match ...Flag) Flag {
	if len(match) > 0 {
		return typedFrom[Flag](e.Match(asMap(match[0])))
	}
	return typedFrom[Flag](e.Match())
}
...
func (e *FlagEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FlagEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FlagLoadMatch and returns an Flag. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FlagEntity) LoadTyped(reqmatch FlagLoadMatch, ctrl map[string]any) (Flag, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Flag{}, err
	}
	return typedFrom[Flag](res), nil
}



func (e *FlagEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *FlagEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FlagEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FlagEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FlagEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
