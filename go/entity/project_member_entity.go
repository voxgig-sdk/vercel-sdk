...
func NewProjectMemberEntity(client *core.VercelSDK, entopts map[string]any) *ProjectMemberEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ProjectMemberEntity) GetName() string { return e.name }
...
func (e *ProjectMemberEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ProjectMemberEntity) Deleted() bool {
	return e.deleted
}


func (e *ProjectMemberEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewProjectMemberEntity(e.client, opts)
}

func (e *ProjectMemberEntity) Data(args ...any) any {
...
func (e *ProjectMemberEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ProjectMember; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ProjectMemberEntity) DataTyped(data ...ProjectMember) ProjectMember {
	if len(data) > 0 {
		return typedFrom[ProjectMember](e.Data(asMap(data[0])))
	}
	return typedFrom[ProjectMember](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ProjectMember (all fields
// optional at the wire level).
func (e *ProjectMemberEntity) MatchTyped(match ...ProjectMember) ProjectMember {
	if len(match) > 0 {
		return typedFrom[ProjectMember](e.Match(asMap(match[0])))
	}
	return typedFrom[ProjectMember](e.Match())
}
...
func (e *ProjectMemberEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ProjectMemberEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ProjectMemberLoadMatch and returns an ProjectMember. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ProjectMemberEntity) LoadTyped(reqmatch ProjectMemberLoadMatch, ctrl map[string]any) (ProjectMember, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return ProjectMember{}, err
	}
	return typedFrom[ProjectMember](res), nil
}



func (e *ProjectMemberEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *ProjectMemberEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ProjectMemberCreateData and returns an ProjectMember. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ProjectMemberEntity) CreateTyped(reqdata ProjectMemberCreateData, ctrl map[string]any) (ProjectMember, error) {
...
func (e *ProjectMemberEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *ProjectMemberEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ProjectMemberRemoveMatch and returns an ProjectMember. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ProjectMemberEntity) RemoveTyped(reqmatch ProjectMemberRemoveMatch, ctrl map[string]any) (ProjectMember, error) {
...
func (e *ProjectMemberEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
