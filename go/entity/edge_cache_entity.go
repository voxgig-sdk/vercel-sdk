...
func NewEdgeCacheEntity(client *core.VercelSDK, entopts map[string]any) *EdgeCacheEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EdgeCacheEntity) GetName() string { return e.name }
...
func (e *EdgeCacheEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EdgeCacheEntity) Deleted() bool {
	return e.deleted
}


func (e *EdgeCacheEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEdgeCacheEntity(e.client, opts)
}

func (e *EdgeCacheEntity) Data(args ...any) any {
...
func (e *EdgeCacheEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an EdgeCache; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EdgeCacheEntity) DataTyped(data ...EdgeCache) EdgeCache {
	if len(data) > 0 {
		return typedFrom[EdgeCache](e.Data(asMap(data[0])))
	}
	return typedFrom[EdgeCache](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through EdgeCache (all fields
// optional at the wire level).
func (e *EdgeCacheEntity) MatchTyped(match ...EdgeCache) EdgeCache {
	if len(match) > 0 {
		return typedFrom[EdgeCache](e.Match(asMap(match[0])))
	}
	return typedFrom[EdgeCache](e.Match())
}
...
func (e *EdgeCacheEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EdgeCacheEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EdgeCacheEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EdgeCacheEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EdgeCacheCreateData and returns an EdgeCache. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EdgeCacheEntity) CreateTyped(reqdata EdgeCacheCreateData, ctrl map[string]any) (EdgeCache, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return EdgeCache{}, err
	}
	return typedFrom[EdgeCache](res), nil
}



func (e *EdgeCacheEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EdgeCacheEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EdgeCacheEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
