...
type GlobalConfigTokenEntity struct {
	name    string
...
func NewGlobalConfigTokenEntity(client *core.VercelSDK, entopts map[string]any) *GlobalConfigTokenEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GlobalConfigTokenEntity) GetName() string { return e.name }
...
func (e *GlobalConfigTokenEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GlobalConfigTokenEntity) Deleted() bool {
	return e.deleted
}


func (e *GlobalConfigTokenEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGlobalConfigTokenEntity(e.client, opts)
}

func (e *GlobalConfigTokenEntity) Data(args ...any) any {
...
func (e *GlobalConfigTokenEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GlobalConfigToken; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GlobalConfigTokenEntity) DataTyped(data ...GlobalConfigToken) GlobalConfigToken {
	if len(data) > 0 {
		return typedFrom[GlobalConfigToken](e.Data(asMap(data[0])))
	}
	return typedFrom[GlobalConfigToken](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GlobalConfigToken (all fields
// optional at the wire level).
func (e *GlobalConfigTokenEntity) MatchTyped(match ...GlobalConfigToken) GlobalConfigToken {
	if len(match) > 0 {
		return typedFrom[GlobalConfigToken](e.Match(asMap(match[0])))
	}
	return typedFrom[GlobalConfigToken](e.Match())
}
...
func (e *GlobalConfigTokenEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GlobalConfigTokenEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GlobalConfigTokenLoadMatch and returns an GlobalConfigToken. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GlobalConfigTokenEntity) LoadTyped(reqmatch GlobalConfigTokenLoadMatch, ctrl map[string]any) (GlobalConfigToken, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GlobalConfigToken{}, err
	}
	return typedFrom[GlobalConfigToken](res), nil
}



func (e *GlobalConfigTokenEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GlobalConfigTokenEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GlobalConfigTokenEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GlobalConfigTokenEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GlobalConfigTokenEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
