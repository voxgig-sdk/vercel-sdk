...
func NewKmsEntity(client *core.VercelSDK, entopts map[string]any) *KmsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *KmsEntity) GetName() string { return e.name }
...
func (e *KmsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *KmsEntity) Deleted() bool {
	return e.deleted
}


func (e *KmsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewKmsEntity(e.client, opts)
}

func (e *KmsEntity) Data(args ...any) any {
...
func (e *KmsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Kms; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *KmsEntity) DataTyped(data ...Kms) Kms {
	if len(data) > 0 {
		return typedFrom[Kms](e.Data(asMap(data[0])))
	}
	return typedFrom[Kms](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Kms (all fields
// optional at the wire level).
func (e *KmsEntity) MatchTyped(match ...Kms) Kms {
	if len(match) > 0 {
		return typedFrom[Kms](e.Match(asMap(match[0])))
	}
	return typedFrom[Kms](e.Match())
}
...
func (e *KmsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *KmsEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// KmsLoadMatch and returns an Kms. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *KmsEntity) LoadTyped(reqmatch KmsLoadMatch, ctrl map[string]any) (Kms, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Kms{}, err
	}
	return typedFrom[Kms](res), nil
}




func (e *KmsEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// KmsListMatch and returns []Kms. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *KmsEntity) ListTyped(reqmatch KmsListMatch, ctrl map[string]any) ([]Kms, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Kms](res), nil
}




func (e *KmsEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// KmsCreateData and returns an Kms. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *KmsEntity) CreateTyped(reqdata KmsCreateData, ctrl map[string]any) (Kms, error) {
...
func (e *KmsEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// KmsUpdateData and returns an Kms. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *KmsEntity) UpdateTyped(reqdata KmsUpdateData, ctrl map[string]any) (Kms, error) {
...
func (e *KmsEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// KmsRemoveMatch and returns an Kms. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *KmsEntity) RemoveTyped(reqmatch KmsRemoveMatch, ctrl map[string]any) (Kms, error) {
...
func (e *KmsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
