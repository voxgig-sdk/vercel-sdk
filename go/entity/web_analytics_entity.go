...
type WebAnalyticsEntity struct {
	name    string
...
func NewWebAnalyticsEntity(client *core.VercelSDK, entopts map[string]any) *WebAnalyticsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WebAnalyticsEntity) GetName() string { return e.name }
...
func (e *WebAnalyticsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WebAnalyticsEntity) Deleted() bool {
	return e.deleted
}


func (e *WebAnalyticsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWebAnalyticsEntity(e.client, opts)
}

func (e *WebAnalyticsEntity) Data(args ...any) any {
...
func (e *WebAnalyticsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an WebAnalytics; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WebAnalyticsEntity) DataTyped(data ...WebAnalytics) WebAnalytics {
	if len(data) > 0 {
		return typedFrom[WebAnalytics](e.Data(asMap(data[0])))
	}
	return typedFrom[WebAnalytics](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through WebAnalytics (all fields
// optional at the wire level).
func (e *WebAnalyticsEntity) MatchTyped(match ...WebAnalytics) WebAnalytics {
	if len(match) > 0 {
		return typedFrom[WebAnalytics](e.Match(asMap(match[0])))
	}
	return typedFrom[WebAnalytics](e.Match())
}
...
func (e *WebAnalyticsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WebAnalyticsEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WebAnalyticsLoadMatch and returns an WebAnalytics. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WebAnalyticsEntity) LoadTyped(reqmatch WebAnalyticsLoadMatch, ctrl map[string]any) (WebAnalytics, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return WebAnalytics{}, err
	}
	return typedFrom[WebAnalytics](res), nil
}



func (e *WebAnalyticsEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WebAnalyticsEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WebAnalyticsEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WebAnalyticsEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WebAnalyticsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
