...
func NewLogDrainEntity(client *core.VercelSDK, entopts map[string]any) *LogDrainEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LogDrainEntity) GetName() string { return e.name }
...
func (e *LogDrainEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LogDrainEntity) Deleted() bool {
	return e.deleted
}


func (e *LogDrainEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLogDrainEntity(e.client, opts)
}

func (e *LogDrainEntity) Data(args ...any) any {
...
func (e *LogDrainEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LogDrain; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LogDrainEntity) DataTyped(data ...LogDrain) LogDrain {
	if len(data) > 0 {
		return typedFrom[LogDrain](e.Data(asMap(data[0])))
	}
	return typedFrom[LogDrain](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LogDrain (all fields
// optional at the wire level).
func (e *LogDrainEntity) MatchTyped(match ...LogDrain) LogDrain {
	if len(match) > 0 {
		return typedFrom[LogDrain](e.Match(asMap(match[0])))
	}
	return typedFrom[LogDrain](e.Match())
}
...
func (e *LogDrainEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LogDrainEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LogDrainLoadMatch and returns an LogDrain. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LogDrainEntity) LoadTyped(reqmatch LogDrainLoadMatch, ctrl map[string]any) (LogDrain, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return LogDrain{}, err
	}
	return typedFrom[LogDrain](res), nil
}




func (e *LogDrainEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// LogDrainListMatch and returns []LogDrain. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LogDrainEntity) ListTyped(reqmatch LogDrainListMatch, ctrl map[string]any) ([]LogDrain, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LogDrain](res), nil
}




func (e *LogDrainEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// LogDrainCreateData and returns an LogDrain. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *LogDrainEntity) CreateTyped(reqdata LogDrainCreateData, ctrl map[string]any) (LogDrain, error) {
...
func (e *LogDrainEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *LogDrainEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// LogDrainRemoveMatch and returns an LogDrain. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *LogDrainEntity) RemoveTyped(reqmatch LogDrainRemoveMatch, ctrl map[string]any) (LogDrain, error) {
...
func (e *LogDrainEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
