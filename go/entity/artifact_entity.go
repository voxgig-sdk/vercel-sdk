...
func NewArtifactEntity(client *core.VercelSDK, entopts map[string]any) *ArtifactEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ArtifactEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ArtifactCreateData and returns an Artifact. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ArtifactEntity) CreateTyped(reqdata ArtifactCreateData, ctrl map[string]any) (Artifact, error) {
...
func (e *ArtifactEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ArtifactUpdateData and returns an Artifact. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ArtifactEntity) UpdateTyped(reqdata ArtifactUpdateData, ctrl map[string]any) (Artifact, error) {
...
func (e *ArtifactEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// ArtifactRemoveMatch and returns an Artifact. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *ArtifactEntity) RemoveTyped(reqmatch ArtifactRemoveMatch, ctrl map[string]any) (Artifact, error) {
