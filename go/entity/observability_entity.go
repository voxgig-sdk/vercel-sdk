...
type ObservabilityEntity struct {
	name    string
...
func NewObservabilityEntity(client *core.VercelSDK, entopts map[string]any) *ObservabilityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ObservabilityEntity) GetName() string { return e.name }
...
func (e *ObservabilityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ObservabilityEntity) Deleted() bool {
	return e.deleted
}


func (e *ObservabilityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewObservabilityEntity(e.client, opts)
}

func (e *ObservabilityEntity) Data(args ...any) any {
...
func (e *ObservabilityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Observability; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ObservabilityEntity) DataTyped(data ...Observability) Observability {
	if len(data) > 0 {
		return typedFrom[Observability](e.Data(asMap(data[0])))
	}
	return typedFrom[Observability](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Observability (all fields
// optional at the wire level).
func (e *ObservabilityEntity) MatchTyped(match ...Observability) Observability {
	if len(match) > 0 {
		return typedFrom[Observability](e.Match(asMap(match[0])))
	}
	return typedFrom[Observability](e.Match())
}
...
func (e *ObservabilityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ObservabilityEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ObservabilityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ObservabilityListMatch and returns []Observability. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ObservabilityEntity) ListTyped(reqmatch ObservabilityListMatch, ctrl map[string]any) ([]Observability, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Observability](res), nil
}



func (e *ObservabilityEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *ObservabilityEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ObservabilityUpdateData and returns an Observability. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ObservabilityEntity) UpdateTyped(reqdata ObservabilityUpdateData, ctrl map[string]any) (Observability, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Observability{}, err
	}
	return typedFrom[Observability](res), nil
}



func (e *ObservabilityEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ObservabilityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
