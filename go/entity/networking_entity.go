...
func NewNetworkingEntity(client *core.VercelSDK, entopts map[string]any) *NetworkingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NetworkingEntity) GetName() string { return e.name }
...
func (e *NetworkingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NetworkingEntity) Deleted() bool {
	return e.deleted
}


func (e *NetworkingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNetworkingEntity(e.client, opts)
}

func (e *NetworkingEntity) Data(args ...any) any {
...
func (e *NetworkingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Networking; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NetworkingEntity) DataTyped(data ...Networking) Networking {
	if len(data) > 0 {
		return typedFrom[Networking](e.Data(asMap(data[0])))
	}
	return typedFrom[Networking](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Networking (all fields
// optional at the wire level).
func (e *NetworkingEntity) MatchTyped(match ...Networking) Networking {
	if len(match) > 0 {
		return typedFrom[Networking](e.Match(asMap(match[0])))
	}
	return typedFrom[Networking](e.Match())
}
...
func (e *NetworkingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NetworkingEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *NetworkingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *NetworkingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}



func (e *NetworkingEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NetworkingUpdateData and returns an Networking. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *NetworkingEntity) UpdateTyped(reqdata NetworkingUpdateData, ctrl map[string]any) (Networking, error) {
	res, err := e.Update(asMap(reqdata), ctrl)
	if err != nil {
		return Networking{}, err
	}
	return typedFrom[Networking](res), nil
}




func (e *NetworkingEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// NetworkingRemoveMatch and returns an Networking. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *NetworkingEntity) RemoveTyped(reqmatch NetworkingRemoveMatch, ctrl map[string]any) (Networking, error) {
...
func (e *NetworkingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
