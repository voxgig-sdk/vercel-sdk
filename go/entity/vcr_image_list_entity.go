...
type VcrImageListEntity struct {
	name    string
...
func NewVcrImageListEntity(client *core.VercelSDK, entopts map[string]any) *VcrImageListEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VcrImageListEntity) GetName() string { return e.name }
...
func (e *VcrImageListEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VcrImageListEntity) Deleted() bool {
	return e.deleted
}


func (e *VcrImageListEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVcrImageListEntity(e.client, opts)
}

func (e *VcrImageListEntity) Data(args ...any) any {
...
func (e *VcrImageListEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an VcrImageList; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VcrImageListEntity) DataTyped(data ...VcrImageList) VcrImageList {
	if len(data) > 0 {
		return typedFrom[VcrImageList](e.Data(asMap(data[0])))
	}
	return typedFrom[VcrImageList](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through VcrImageList (all fields
// optional at the wire level).
func (e *VcrImageListEntity) MatchTyped(match ...VcrImageList) VcrImageList {
	if len(match) > 0 {
		return typedFrom[VcrImageList](e.Match(asMap(match[0])))
	}
	return typedFrom[VcrImageList](e.Match())
}
...
func (e *VcrImageListEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VcrImageListEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *VcrImageListEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VcrImageListListMatch and returns []VcrImageList. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VcrImageListEntity) ListTyped(reqmatch VcrImageListListMatch, ctrl map[string]any) ([]VcrImageList, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[VcrImageList](res), nil
}



func (e *VcrImageListEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VcrImageListEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VcrImageListEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VcrImageListEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
