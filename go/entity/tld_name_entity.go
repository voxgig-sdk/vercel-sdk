...
func NewTldNameEntity(client *core.VercelSDK, entopts map[string]any) *TldNameEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TldNameEntity) GetName() string { return e.name }
...
func (e *TldNameEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TldNameEntity) Deleted() bool {
	return e.deleted
}


func (e *TldNameEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTldNameEntity(e.client, opts)
}

func (e *TldNameEntity) Data(args ...any) any {
...
func (e *TldNameEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an TldName; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TldNameEntity) DataTyped(data ...TldName) TldName {
	if len(data) > 0 {
		return typedFrom[TldName](e.Data(asMap(data[0])))
	}
	return typedFrom[TldName](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through TldName (all fields
// optional at the wire level).
func (e *TldNameEntity) MatchTyped(match ...TldName) TldName {
	if len(match) > 0 {
		return typedFrom[TldName](e.Match(asMap(match[0])))
	}
	return typedFrom[TldName](e.Match())
}
...
func (e *TldNameEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TldNameEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *TldNameEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TldNameListMatch and returns []TldName. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TldNameEntity) ListTyped(reqmatch TldNameListMatch, ctrl map[string]any) ([]TldName, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[TldName](res), nil
}



func (e *TldNameEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TldNameEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TldNameEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TldNameEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
