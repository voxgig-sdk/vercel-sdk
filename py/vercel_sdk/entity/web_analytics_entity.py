...
class WebAnalyticsEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return WebAnalyticsEntity(self._client, opts)
    ...
    def data_get(self) -> WebAnalytics:
    ...
    def match_get(self) -> WebAnalytics:
    ...
    def load(self, reqmatch=None, ctrl=None) -> WebAnalytics:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.WebAnalytics().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
