...
class ConnectConnectorEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConnectConnectorEntity(self._client, opts)
    ...
    def data_get(self) -> ConnectConnector:
    ...
    def match_get(self) -> ConnectConnector:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConnectConnector:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConnectConnector().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ConnectConnectorCreateData, ctrl=None) -> ConnectConnector:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: ConnectConnectorUpdateData, ctrl=None) -> ConnectConnector:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
