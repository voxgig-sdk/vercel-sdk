...
class ConnectConnectorProjectConnectionListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConnectConnectorProjectConnectionListEntity(self._client, opts)
    ...
    def data_get(self) -> ConnectConnectorProjectConnectionList:
    ...
    def match_get(self) -> ConnectConnectorProjectConnectionList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConnectConnectorProjectConnectionList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConnectConnectorProjectConnectionList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
