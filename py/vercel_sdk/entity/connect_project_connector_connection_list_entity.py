...
class ConnectProjectConnectorConnectionListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConnectProjectConnectorConnectionListEntity(self._client, opts)
    ...
    def data_get(self) -> ConnectProjectConnectorConnectionList:
    ...
    def match_get(self) -> ConnectProjectConnectorConnectionList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConnectProjectConnectorConnectionList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConnectProjectConnectorConnectionList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
