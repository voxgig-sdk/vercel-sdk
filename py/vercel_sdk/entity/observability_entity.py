...
class ObservabilityEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ObservabilityEntity(self._client, opts)
    ...
    def data_get(self) -> Observability:
    ...
    def match_get(self) -> Observability:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Observability]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Observability().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def update(self, reqdata: ObservabilityUpdateData, ctrl=None) -> Observability:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
