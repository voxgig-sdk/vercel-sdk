...
class FlagsSdkKeyWithSecretEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return FlagsSdkKeyWithSecretEntity(self._client, opts)
    ...
    def data_get(self) -> FlagsSdkKeyWithSecret:
    ...
    def match_get(self) -> FlagsSdkKeyWithSecret:
    ...
    def update(self, reqdata: FlagsSdkKeyWithSecretUpdateData, ctrl=None) -> FlagsSdkKeyWithSecret:
        utility = self._utility
