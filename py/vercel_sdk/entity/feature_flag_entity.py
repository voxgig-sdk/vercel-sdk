...
class FeatureFlagEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[FeatureFlag]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.FeatureFlag().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
    ...
    def update(self, reqdata: FeatureFlagUpdateData, ctrl=None) -> FeatureFlag:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
