...
class AiGatewayVirtualModelConfigListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AiGatewayVirtualModelConfigListEntity(self._client, opts)
    ...
    def data_get(self) -> AiGatewayVirtualModelConfigList:
    ...
    def match_get(self) -> AiGatewayVirtualModelConfigList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AiGatewayVirtualModelConfigList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AiGatewayVirtualModelConfigList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
