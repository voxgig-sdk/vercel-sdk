...
class VcrRepositoryListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return VcrRepositoryListEntity(self._client, opts)
    ...
    def data_get(self) -> VcrRepositoryList:
    ...
    def match_get(self) -> VcrRepositoryList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[VcrRepositoryList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.VcrRepositoryList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
