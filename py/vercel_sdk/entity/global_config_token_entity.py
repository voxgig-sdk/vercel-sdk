...
class GlobalConfigTokenEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GlobalConfigTokenEntity(self._client, opts)
    ...
    def data_get(self) -> GlobalConfigToken:
    ...
    def match_get(self) -> GlobalConfigToken:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GlobalConfigToken:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GlobalConfigToken().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
