...
class AiGatewayRuleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AiGatewayRuleEntity(self._client, opts)
    ...
    def data_get(self) -> AiGatewayRule:
    ...
    def match_get(self) -> AiGatewayRule:
    ...
    def create(self, reqdata: AiGatewayRuleCreateData, ctrl=None) -> AiGatewayRule:
        utility = self._utility
    ...
    def update(self, reqdata: AiGatewayRuleUpdateData, ctrl=None) -> AiGatewayRule:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
