...
class ConnectConnectorListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConnectConnectorListEntity(self._client, opts)
    ...
    def data_get(self) -> ConnectConnectorList:
    ...
    def match_get(self) -> ConnectConnectorList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ConnectConnectorList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ConnectConnectorList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
