...
class ConnectProjectConnectionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ConnectProjectConnectionEntity(self._client, opts)
    ...
    def data_get(self) -> ConnectProjectConnection:
    ...
    def match_get(self) -> ConnectProjectConnection:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ConnectProjectConnection:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ConnectProjectConnection().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: ConnectProjectConnectionCreateData, ctrl=None) -> ConnectProjectConnection:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
