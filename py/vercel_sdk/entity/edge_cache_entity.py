...
class EdgeCacheEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EdgeCacheEntity(self._client, opts)
    ...
    def create(self, reqdata: EdgeCacheCreateData, ctrl=None) -> EdgeCache:
        utility = self._utility
