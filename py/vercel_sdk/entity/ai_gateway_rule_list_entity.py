...
class AiGatewayRuleListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AiGatewayRuleListEntity(self._client, opts)
    ...
    def data_get(self) -> AiGatewayRuleList:
    ...
    def match_get(self) -> AiGatewayRuleList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[AiGatewayRuleList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.AiGatewayRuleList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
