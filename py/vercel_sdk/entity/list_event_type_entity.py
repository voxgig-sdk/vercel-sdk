...
class ListEventTypeEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ListEventTypeEntity(self._client, opts)
    ...
    def data_get(self) -> ListEventType:
    ...
    def match_get(self) -> ListEventType:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[ListEventType]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.ListEventType().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
