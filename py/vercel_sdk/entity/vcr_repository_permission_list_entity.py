...
class VcrRepositoryPermissionListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return VcrRepositoryPermissionListEntity(self._client, opts)
    ...
    def data_get(self) -> VcrRepositoryPermissionList:
    ...
    def match_get(self) -> VcrRepositoryPermissionList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[VcrRepositoryPermissionList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.VcrRepositoryPermissionList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
