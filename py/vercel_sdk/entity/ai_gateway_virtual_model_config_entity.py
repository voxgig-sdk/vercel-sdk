...
class AiGatewayVirtualModelConfigEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return AiGatewayVirtualModelConfigEntity(self._client, opts)
    ...
    def data_get(self) -> AiGatewayVirtualModelConfig:
    ...
    def match_get(self) -> AiGatewayVirtualModelConfig:
    ...
    def load(self, reqmatch=None, ctrl=None) -> AiGatewayVirtualModelConfig:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.AiGatewayVirtualModelConfig().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def create(self, reqdata: AiGatewayVirtualModelConfigCreateData, ctrl=None) -> AiGatewayVirtualModelConfig:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "create",
            "ctrl": ctrl,
    ...
    def update(self, reqdata: AiGatewayVirtualModelConfigUpdateData, ctrl=None) -> AiGatewayVirtualModelConfig:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "update",
            "ctrl": ctrl,
