...
class VcrImageListEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return VcrImageListEntity(self._client, opts)
    ...
    def data_get(self) -> VcrImageList:
    ...
    def match_get(self) -> VcrImageList:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[VcrImageList]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.VcrImageList().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
