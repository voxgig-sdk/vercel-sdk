...
class TestConnectConnectorDirect:

    def test_should_direct_load_connect_connector(self):
        setup = _connect_connector_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-connect_connector", "live" if setup["live"] else "unit")
        if _skip:
...
def _connect_connector_direct_setup(mockres):
