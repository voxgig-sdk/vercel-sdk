...
class TestRecordDirect:
    ...
    def test_should_direct_load_record(self):
        setup = _record_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-record", "live" if setup["live"] else "unit")
        if _skip:
