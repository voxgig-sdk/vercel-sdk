...
class DomainEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_DOMAIN_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $domain_ref01_data_result = $domain_ref01_ent->create($domain_ref01_data, null);
        $domain_ref01_data = Helpers::to_map(is_object($domain_ref01_data_result) && method_exists($domain_ref01_data_result, 'data_get') ? $domain_ref01_data_result->data_get() : $domain_ref01_data_result);
        $this->assertNotNull($domain_ref01_data);
        $this->assertNotNull($domain_ref01_data["id"]);
        ...
        $domain_ref01_markdef_up0_name = "echMode";
        ...
        $domain_ref01_resdata_up0_result = $domain_ref01_ent->update($domain_ref01_data_up0_up, null);
        $domain_ref01_resdata_up0 = Helpers::to_map(is_object($domain_ref01_resdata_up0_result) && method_exists($domain_ref01_resdata_up0_result, 'data_get') ? $domain_ref01_resdata_up0_result->data_get() : $domain_ref01_resdata_up0_result);
        $this->assertNotNull($domain_ref01_resdata_up0);
        $this->assertEquals($domain_ref01_resdata_up0["id"], $domain_ref01_data_up0_up["id"]);
        $this->assertEquals($domain_ref01_resdata_up0[$domain_ref01_markdef_up0_name], $domain_ref01_markdef_up0_value);
        ...
        $domain_ref01_ent->remove($domain_ref01_match_rm0, null);

        // LIST
        $domain_ref01_match_rt0 = [];

        $domain_ref01_list_rt0_result = $domain_ref01_ent->list($domain_ref01_match_rt0, null);
        $this->assertIsArray($domain_ref01_list_rt0_result);
...
function domain_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("VERCEL_TEST_DOMAIN_ENTID");
