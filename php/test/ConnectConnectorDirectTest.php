...
class ConnectConnectorDirectTest extends TestCase
{
    public function test_direct_load_connect_connector(): void
    {
        $setup = connect_connector_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-connect_connector", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
