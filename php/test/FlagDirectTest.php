...
class FlagDirectTest extends TestCase
{
    public function test_direct_load_flag(): void
    {
        $setup = flag_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-flag", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
