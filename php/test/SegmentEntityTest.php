...
class SegmentEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_SEGMENT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function segment_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["segment01", "segment02", "segment03", "project01", "project02", "project03"] as $k) {
    ...
    $entid_env_raw = getenv("VERCEL_TEST_SEGMENT_ENTID");
