...
{
    public function test_direct_load_record(): void
    {
        $setup = record_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-record", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
