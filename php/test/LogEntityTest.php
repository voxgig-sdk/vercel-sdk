...
class LogEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_LOG_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function log_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["log01", "log02", "log03", "project01", "project02", "project03", "deployment01", "deployment02", "deployment03"] as $k) {
    ...
    $entid_env_raw = getenv("VERCEL_TEST_LOG_ENTID");
