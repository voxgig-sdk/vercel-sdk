...
class StorageDirectTest extends TestCase
{
    public function test_direct_load_storage(): void
    {
        $setup = storage_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-storage", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
