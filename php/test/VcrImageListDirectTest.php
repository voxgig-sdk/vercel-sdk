...
class VcrImageListDirectTest extends TestCase
{
    public function test_direct_list_vcr_image_list(): void
    {
        $setup = vcr_image_list_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-vcr_image_list", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
