...
class ApiKeyEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_API_KEY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function api_key_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("VERCEL_TEST_API_KEY_ENTID");
