...
class TeamEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_TEAM_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function team_basic_setup($extra)
{
    ...
    // Generate idmap.
    $idmap = [];
    foreach (["team01", "team02", "team03", "invite01", "invite02", "invite03", "member01", "member02", "member03", "microfrontend01", "microfrontend02", "microfrontend03", "request01", "request02", "request03"] as $k) {
    ...
    $entid_env_raw = getenv("VERCEL_TEST_TEAM_ENTID");
