...
class VcrImageListEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VcrImageListEntity($this->_client, $opts);
    }

    /**
     * @param VcrImageList|array $args VcrImageList data (assoc-array) to store.
     */
    ...
    /**
     * @return VcrImageList|array The current VcrImageList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of VcrImageList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of VcrImageList fields).
     */
    ...
    /**
     * List VcrImageList items matching the given filter.
     *
     * @param VcrImageListListMatch|array|null $reqmatch Match filter (any subset
     *   of VcrImageList fields) as an assoc-array; VcrImageListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return VcrImageList[]|array A list of VcrImageList items as assoc-arrays at
