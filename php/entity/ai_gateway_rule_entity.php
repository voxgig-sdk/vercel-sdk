...
class AiGatewayRuleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiGatewayRuleEntity($this->_client, $opts);
    }

    /**
     * @param AiGatewayRule|array $args AiGatewayRule data (assoc-array) to store.
     */
    ...
    /**
     * @return AiGatewayRule|array The current AiGatewayRule data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiGatewayRule fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiGatewayRule fields).
     */
    ...
    /**
     * Create a new AiGatewayRule.
     *
     * @param AiGatewayRuleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiGatewayRuleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGatewayRule|array The created AiGatewayRule as an assoc-array at the
    ...
    /**
     * Update an existing AiGatewayRule.
     *
     * @param AiGatewayRuleUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiGatewayRuleUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGatewayRule|array The updated AiGatewayRule as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
