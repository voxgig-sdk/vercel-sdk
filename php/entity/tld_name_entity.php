...
class TldNameEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TldNameEntity($this->_client, $opts);
    }

    /**
     * @param TldName|array $args TldName data (assoc-array) to store.
     */
    ...
    /**
     * @return TldName|array The current TldName data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of TldName fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of TldName fields).
     */
    ...
    /**
     * List TldName items matching the given filter.
     *
     * @param TldNameListMatch|array|null $reqmatch Match filter (any subset
     *   of TldName fields) as an assoc-array; TldNameListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return TldName[]|array A list of TldName items as assoc-arrays at
