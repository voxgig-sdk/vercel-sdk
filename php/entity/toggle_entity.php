...
class ToggleEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ToggleEntity($this->_client, $opts);
    }

    /**
     * @param Toggle|array $args Toggle data (assoc-array) to store.
     */
    ...
    /**
     * @return Toggle|array The current Toggle data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Toggle fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Toggle fields).
     */
     ...
     * Create a new Toggle.
     *
     * @param ToggleCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ToggleCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Toggle|array The created Toggle as an assoc-array at the
