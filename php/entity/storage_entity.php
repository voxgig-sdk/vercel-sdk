...
class StorageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StorageEntity($this->_client, $opts);
    }

    /**
     * @param Storage|array $args Storage data (assoc-array) to store.
     */
    ...
    /**
     * @return Storage|array The current Storage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Storage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Storage fields).
     */
    ...
    /**
     * Load a single Storage.
     *
     * @param StorageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StorageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Storage|array The loaded Storage as an assoc-array at the
     ...
     *
     * @param StorageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed StorageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Storage|array The created Storage as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Storage matching the given criteria.
     *
     * @param StorageRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; StorageRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Storage|array The removed Storage as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
