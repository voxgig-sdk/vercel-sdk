...
class SandboxEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SandboxEntity($this->_client, $opts);
    }

    /**
     * @param Sandbox|array $args Sandbox data (assoc-array) to store.
     */
    ...
    /**
     * @return Sandbox|array The current Sandbox data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Sandbox fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Sandbox fields).
     */
    ...
    /**
     * Load a single Sandbox.
     *
     * @param SandboxLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SandboxLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sandbox|array The loaded Sandbox as an assoc-array at the
    ...
    /**
     * List Sandbox items matching the given filter.
     *
     * @param SandboxListMatch|array|null $reqmatch Match filter (any subset
     *   of Sandbox fields) as an assoc-array; SandboxListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sandbox[]|array A list of Sandbox items as assoc-arrays at
     ...
     *
     * @param SandboxCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SandboxCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sandbox|array The created Sandbox as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param SandboxUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SandboxUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sandbox|array The updated Sandbox as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Sandbox matching the given criteria.
     *
     * @param SandboxRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SandboxRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Sandbox|array The removed Sandbox as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
