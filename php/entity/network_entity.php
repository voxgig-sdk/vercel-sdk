...
class NetworkEntity
{
     ...
     *
     * @param NetworkCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NetworkCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Network|array The created Network as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param NetworkUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NetworkUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Network|array The updated Network as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Network matching the given criteria.
     *
     * @param NetworkRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; NetworkRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Network|array The removed Network as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
