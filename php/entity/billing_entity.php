...
class BillingEntity
{
     ...
     *
     * @param BillingCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BillingCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Billing|array The created Billing as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
