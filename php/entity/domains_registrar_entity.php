...
// Vercel SDK DomainsRegistrar entity
...
class DomainsRegistrarEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DomainsRegistrarEntity($this->_client, $opts);
    }

    /**
     * @param DomainsRegistrar|array $args DomainsRegistrar data (assoc-array) to store.
     */
    ...
    /**
     * @return DomainsRegistrar|array The current DomainsRegistrar data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of DomainsRegistrar fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of DomainsRegistrar fields).
     */
    ...
    /**
     * Load a single DomainsRegistrar.
     *
     * @param DomainsRegistrarLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DomainsRegistrarLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DomainsRegistrar|array The loaded DomainsRegistrar as an assoc-array at the
    ...
    /**
     * Create a new DomainsRegistrar.
     *
     * @param DomainsRegistrarCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DomainsRegistrarCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DomainsRegistrar|array The created DomainsRegistrar as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing DomainsRegistrar.
     *
     * @param DomainsRegistrarUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DomainsRegistrarUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return DomainsRegistrar|array The updated DomainsRegistrar as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
