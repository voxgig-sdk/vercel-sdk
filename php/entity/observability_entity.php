...
// Vercel SDK Observability entity
...
class ObservabilityEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ObservabilityEntity($this->_client, $opts);
    }

    /**
     * @param Observability|array $args Observability data (assoc-array) to store.
     */
    ...
    /**
     * @return Observability|array The current Observability data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Observability fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Observability fields).
     */
    ...
    /**
     * List Observability items matching the given filter.
     *
     * @param ObservabilityListMatch|array|null $reqmatch Match filter (any subset
     *   of Observability fields) as an assoc-array; ObservabilityListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Observability[]|array A list of Observability items as assoc-arrays at
    ...
    /**
     * Update an existing Observability.
     *
     * @param ObservabilityUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ObservabilityUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Observability|array The updated Observability as an assoc-array at the
