...
// Vercel SDK GlobalConfigItem entity
...
class GlobalConfigItemEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GlobalConfigItemEntity($this->_client, $opts);
    }

    /**
     * @param GlobalConfigItem|array $args GlobalConfigItem data (assoc-array) to store.
     */
    ...
    /**
     * @return GlobalConfigItem|array The current GlobalConfigItem data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GlobalConfigItem fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GlobalConfigItem fields).
     */
    ...
    /**
     * Load a single GlobalConfigItem.
     *
     * @param GlobalConfigItemLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GlobalConfigItemLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfigItem|array The loaded GlobalConfigItem as an assoc-array at the
    ...
    /**
     * List GlobalConfigItem items matching the given filter.
     *
     * @param GlobalConfigItemListMatch|array|null $reqmatch Match filter (any subset
     *   of GlobalConfigItem fields) as an assoc-array; GlobalConfigItemListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfigItem[]|array A list of GlobalConfigItem items as assoc-arrays at
