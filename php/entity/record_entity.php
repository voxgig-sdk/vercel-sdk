...
class RecordEntity
{
     ...
     *
     * @param RecordLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RecordLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Record|array The loaded Record as an assoc-array at the
