...
class MarketplaceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MarketplaceEntity($this->_client, $opts);
    }

    /**
     * @param Marketplace|array $args Marketplace data (assoc-array) to store.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Marketplace fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Marketplace fields).
     */
    ...
    /**
     * Load a single Marketplace.
     *
     * @param MarketplaceLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MarketplaceLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Marketplace|array The loaded Marketplace as an assoc-array at the
    ...
    /**
     * List Marketplace items matching the given filter.
     *
     * @param MarketplaceListMatch|array|null $reqmatch Match filter (any subset
     *   of Marketplace fields) as an assoc-array; MarketplaceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Marketplace[]|array A list of Marketplace items as assoc-arrays at
     ...
     *
     * @param MarketplaceCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MarketplaceCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Marketplace|array The created Marketplace as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param MarketplaceUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MarketplaceUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Marketplace|array The updated Marketplace as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Marketplace matching the given criteria.
     *
     * @param MarketplaceRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; MarketplaceRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Marketplace|array The removed Marketplace as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
