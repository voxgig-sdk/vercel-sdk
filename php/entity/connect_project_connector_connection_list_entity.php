...
class ConnectProjectConnectorConnectionListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "connect_project_connector_connection_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConnectProjectConnectorConnectionListEntity($this->_client, $opts);
    }

    /**
     * @param ConnectProjectConnectorConnectionList|array $args ConnectProjectConnectorConnectionList data (assoc-array) to store.
     */
    ...
    /**
     * @return ConnectProjectConnectorConnectionList|array The current ConnectProjectConnectorConnectionList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConnectProjectConnectorConnectionList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConnectProjectConnectorConnectionList fields).
     */
    ...
    /**
     * List ConnectProjectConnectorConnectionList items matching the given filter.
     *
     * @param ConnectProjectConnectorConnectionListListMatch|array|null $reqmatch Match filter (any subset
     *   of ConnectProjectConnectorConnectionList fields) as an assoc-array; ConnectProjectConnectorConnectionListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectProjectConnectorConnectionList[]|array A list of ConnectProjectConnectorConnectionList items as assoc-arrays at
