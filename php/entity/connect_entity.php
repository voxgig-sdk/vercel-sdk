...
class ConnectEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConnectEntity($this->_client, $opts);
    }

    /**
     * @param Connect|array $args Connect data (assoc-array) to store.
     */
    ...
    /**
     * @return Connect|array The current Connect data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Connect fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Connect fields).
     */
     ...
     *
     * @param ConnectCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConnectCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Connect|array The created Connect as an assoc-array at the
    ...
    /**
     * Remove an Connect matching the given criteria.
     *
     * @param ConnectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ConnectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Connect|array The removed Connect as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
