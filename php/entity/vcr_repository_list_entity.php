...
class VcrRepositoryListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "vcr_repository_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new VcrRepositoryListEntity($this->_client, $opts);
    }

    /**
     * @param VcrRepositoryList|array $args VcrRepositoryList data (assoc-array) to store.
     */
    ...
    /**
     * @return VcrRepositoryList|array The current VcrRepositoryList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of VcrRepositoryList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of VcrRepositoryList fields).
     */
    ...
    /**
     * List VcrRepositoryList items matching the given filter.
     *
     * @param VcrRepositoryListListMatch|array|null $reqmatch Match filter (any subset
     *   of VcrRepositoryList fields) as an assoc-array; VcrRepositoryListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return VcrRepositoryList[]|array A list of VcrRepositoryList items as assoc-arrays at
