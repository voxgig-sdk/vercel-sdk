...
class LogDrainEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LogDrainEntity($this->_client, $opts);
    }

    /**
     * @param LogDrain|array $args LogDrain data (assoc-array) to store.
     */
    ...
    /**
     * @return LogDrain|array The current LogDrain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of LogDrain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of LogDrain fields).
     */
    ...
    /**
     * Load a single LogDrain.
     *
     * @param LogDrainLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LogDrainLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LogDrain|array The loaded LogDrain as an assoc-array at the
    ...
    /**
     * List LogDrain items matching the given filter.
     *
     * @param LogDrainListMatch|array|null $reqmatch Match filter (any subset
     *   of LogDrain fields) as an assoc-array; LogDrainListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LogDrain[]|array A list of LogDrain items as assoc-arrays at
    ...
    /**
     * Create a new LogDrain.
     *
     * @param LogDrainCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed LogDrainCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LogDrain|array The created LogDrain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an LogDrain matching the given criteria.
     *
     * @param LogDrainRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; LogDrainRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return LogDrain|array The removed LogDrain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
