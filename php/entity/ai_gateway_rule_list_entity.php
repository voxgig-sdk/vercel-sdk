...
class AiGatewayRuleListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ai_gateway_rule_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AiGatewayRuleListEntity($this->_client, $opts);
    }

    /**
     * @param AiGatewayRuleList|array $args AiGatewayRuleList data (assoc-array) to store.
     */
    ...
    /**
     * @return AiGatewayRuleList|array The current AiGatewayRuleList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiGatewayRuleList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiGatewayRuleList fields).
     */
    ...
    /**
     * List AiGatewayRuleList items matching the given filter.
     *
     * @param AiGatewayRuleListListMatch|array|null $reqmatch Match filter (any subset
     *   of AiGatewayRuleList fields) as an assoc-array; AiGatewayRuleListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGatewayRuleList[]|array A list of AiGatewayRuleList items as assoc-arrays at
