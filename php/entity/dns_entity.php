...
class DnsEntity
{
     ...
     * Create a new Dns.
     *
     * @param DnsCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DnsCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dns|array The created Dns as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Dns.
     *
     * @param DnsUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DnsUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dns|array The updated Dns as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Dns matching the given criteria.
     *
     * @param DnsRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DnsRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dns|array The removed Dns as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
