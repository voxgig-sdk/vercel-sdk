...
class FeatureFlagEntity
{
    ...
    /**
     * List FeatureFlag items matching the given filter.
     *
     * @param FeatureFlagListMatch|array|null $reqmatch Match filter (any subset
     *   of FeatureFlag fields) as an assoc-array; FeatureFlagListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FeatureFlag[]|array A list of FeatureFlag items as assoc-arrays at
     ...
     *
     * @param FeatureFlagUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FeatureFlagUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FeatureFlag|array The updated FeatureFlag as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
