...
// Vercel SDK BulkRedirect entity
...
class BulkRedirectEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BulkRedirectEntity($this->_client, $opts);
    }

    /**
     * @param BulkRedirect|array $args BulkRedirect data (assoc-array) to store.
     */
    ...
    /**
     * @return BulkRedirect|array The current BulkRedirect data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of BulkRedirect fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of BulkRedirect fields).
     */
    ...
    /**
     * Load a single BulkRedirect.
     *
     * @param BulkRedirectLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BulkRedirectLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkRedirect|array The loaded BulkRedirect as an assoc-array at the
    ...
    /**
     * List BulkRedirect items matching the given filter.
     *
     * @param BulkRedirectListMatch|array|null $reqmatch Match filter (any subset
     *   of BulkRedirect fields) as an assoc-array; BulkRedirectListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkRedirect[]|array A list of BulkRedirect items as assoc-arrays at
    ...
    /**
     * Create a new BulkRedirect.
     *
     * @param BulkRedirectCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BulkRedirectCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkRedirect|array The created BulkRedirect as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing BulkRedirect.
     *
     * @param BulkRedirectUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed BulkRedirectUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkRedirect|array The updated BulkRedirect as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an BulkRedirect matching the given criteria.
     *
     * @param BulkRedirectRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; BulkRedirectRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return BulkRedirect|array The removed BulkRedirect as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
