...
class ChecksV2Entity
{
    ...
    {
        $opts = $this->_entopts;
        return new ChecksV2Entity($this->_client, $opts);
    }

    /**
     * @param ChecksV2|array $args ChecksV2 data (assoc-array) to store.
     */
    ...
    /**
     * @return ChecksV2|array The current ChecksV2 data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ChecksV2 fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ChecksV2 fields).
     */
    ...
    /**
     * Load a single ChecksV2.
     *
     * @param ChecksV2LoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ChecksV2LoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ChecksV2|array The loaded ChecksV2 as an assoc-array at the
    ...
    /**
     * List ChecksV2 items matching the given filter.
     *
     * @param ChecksV2ListMatch|array|null $reqmatch Match filter (any subset
     *   of ChecksV2 fields) as an assoc-array; ChecksV2ListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ChecksV2[]|array A list of ChecksV2 items as assoc-arrays at
    ...
    /**
     * Create a new ChecksV2.
     *
     * @param ChecksV2CreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ChecksV2CreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ChecksV2|array The created ChecksV2 as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ChecksV2.
     *
     * @param ChecksV2UpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ChecksV2UpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ChecksV2|array The updated ChecksV2 as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
