...
class NetworkingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new NetworkingEntity($this->_client, $opts);
    }

    /**
     * @param Networking|array $args Networking data (assoc-array) to store.
     */
    ...
    /**
     * @return Networking|array The current Networking data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Networking fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Networking fields).
     */
    ...
    /**
     * Update an existing Networking.
     *
     * @param NetworkingUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed NetworkingUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Networking|array The updated Networking as an assoc-array at the
    ...
    /**
     * Remove an Networking matching the given criteria.
     *
     * @param NetworkingRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; NetworkingRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Networking|array The removed Networking as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
