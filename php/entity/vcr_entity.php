...
class VcrEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VcrEntity($this->_client, $opts);
    }

    /**
     * @param Vcr|array $args Vcr data (assoc-array) to store.
     */
    ...
    /**
     * @return Vcr|array The current Vcr data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Vcr fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Vcr fields).
     */
     ...
     * Load a single Vcr.
     *
     * @param VcrLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed VcrLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vcr|array The loaded Vcr as an assoc-array at the
    ...
    /**
     * List Vcr items matching the given filter.
     *
     * @param VcrListMatch|array|null $reqmatch Match filter (any subset
     *   of Vcr fields) as an assoc-array; VcrListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vcr[]|array A list of Vcr items as assoc-arrays at
     ...
     * Create a new Vcr.
     *
     * @param VcrCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VcrCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vcr|array The created Vcr as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Vcr.
     *
     * @param VcrUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VcrUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vcr|array The updated Vcr as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Vcr matching the given criteria.
     *
     * @param VcrRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; VcrRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Vcr|array The removed Vcr as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
