...
class DrainEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DrainEntity($this->_client, $opts);
    }

    /**
     * @param Drain|array $args Drain data (assoc-array) to store.
     */
    ...
    /**
     * @return Drain|array The current Drain data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Drain fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Drain fields).
     */
     ...
     * Load a single Drain.
     *
     * @param DrainLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DrainLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Drain|array The loaded Drain as an assoc-array at the
     ...
     * Create a new Drain.
     *
     * @param DrainCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DrainCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Drain|array The created Drain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param DrainUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DrainUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Drain|array The updated Drain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Drain matching the given criteria.
     *
     * @param DrainRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DrainRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Drain|array The removed Drain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
