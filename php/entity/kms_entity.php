...
class KmsEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new KmsEntity($this->_client, $opts);
    }

    /**
     * @param Kms|array $args Kms data (assoc-array) to store.
     */
    ...
    /**
     * @return Kms|array The current Kms data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Kms fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Kms fields).
     */
     ...
     * Load a single Kms.
     *
     * @param KmsLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed KmsLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Kms|array The loaded Kms as an assoc-array at the
    ...
    /**
     * List Kms items matching the given filter.
     *
     * @param KmsListMatch|array|null $reqmatch Match filter (any subset
     *   of Kms fields) as an assoc-array; KmsListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Kms[]|array A list of Kms items as assoc-arrays at
     ...
     * Create a new Kms.
     *
     * @param KmsCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed KmsCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Kms|array The created Kms as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing Kms.
     *
     * @param KmsUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed KmsUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Kms|array The updated Kms as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Kms matching the given criteria.
     *
     * @param KmsRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; KmsRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Kms|array The removed Kms as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
