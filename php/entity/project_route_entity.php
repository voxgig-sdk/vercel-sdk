...
// Vercel SDK ProjectRoute entity
...
class ProjectRouteEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectRouteEntity($this->_client, $opts);
    }

    /**
     * @param ProjectRoute|array $args ProjectRoute data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectRoute|array The current ProjectRoute data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectRoute fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectRoute fields).
     */
    ...
    /**
     * Load a single ProjectRoute.
     *
     * @param ProjectRouteLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectRouteLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectRoute|array The loaded ProjectRoute as an assoc-array at the
    ...
    /**
     * List ProjectRoute items matching the given filter.
     *
     * @param ProjectRouteListMatch|array|null $reqmatch Match filter (any subset
     *   of ProjectRoute fields) as an assoc-array; ProjectRouteListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectRoute[]|array A list of ProjectRoute items as assoc-arrays at
     *   the SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Create a new ProjectRoute.
     *
     * @param ProjectRouteCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectRouteCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectRoute|array The created ProjectRoute as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ProjectRoute.
     *
     * @param ProjectRouteUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectRouteUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectRoute|array The updated ProjectRoute as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ProjectRoute matching the given criteria.
     *
     * @param ProjectRouteRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProjectRouteRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectRoute|array The removed ProjectRoute as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
