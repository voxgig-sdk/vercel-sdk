...
// Vercel SDK GlobalConfig entity
...
class GlobalConfigEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new GlobalConfigEntity($this->_client, $opts);
    }

    /**
     * @param GlobalConfig|array $args GlobalConfig data (assoc-array) to store.
     */
    ...
    /**
     * @return GlobalConfig|array The current GlobalConfig data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GlobalConfig fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GlobalConfig fields).
     */
    ...
    /**
     * Load a single GlobalConfig.
     *
     * @param GlobalConfigLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GlobalConfigLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfig|array The loaded GlobalConfig as an assoc-array at the
    ...
    /**
     * List GlobalConfig items matching the given filter.
     *
     * @param GlobalConfigListMatch|array|null $reqmatch Match filter (any subset
     *   of GlobalConfig fields) as an assoc-array; GlobalConfigListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfig[]|array A list of GlobalConfig items as assoc-arrays at
     ...
     *
     * @param GlobalConfigCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GlobalConfigCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfig|array The created GlobalConfig as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing GlobalConfig.
     *
     * @param GlobalConfigUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed GlobalConfigUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfig|array The updated GlobalConfig as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an GlobalConfig matching the given criteria.
     *
     * @param GlobalConfigRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; GlobalConfigRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfig|array The removed GlobalConfig as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
