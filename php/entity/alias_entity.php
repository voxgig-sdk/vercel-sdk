...
class AliasEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AliasEntity($this->_client, $opts);
    }

    /**
     * @param Alias|array $args Alias data (assoc-array) to store.
     */
    ...
    /**
     * @return Alias|array The current Alias data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Alias fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Alias fields).
     */
     ...
     * Load a single Alias.
     *
     * @param AliasLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AliasLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Alias|array The loaded Alias as an assoc-array at the
    ...
    /**
     * List Alias items matching the given filter.
     *
     * @param AliasListMatch|array|null $reqmatch Match filter (any subset
     *   of Alias fields) as an assoc-array; AliasListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Alias[]|array A list of Alias items as assoc-arrays at
     ...
     * Create a new Alias.
     *
     * @param AliasCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AliasCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Alias|array The created Alias as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param AliasUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AliasUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Alias|array The updated Alias as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Alias matching the given criteria.
     *
     * @param AliasRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AliasRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Alias|array The removed Alias as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
