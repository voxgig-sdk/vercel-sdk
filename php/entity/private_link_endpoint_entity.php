...
// Vercel SDK PrivateLinkEndpoint entity
...
class PrivateLinkEndpointEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "private_link_endpoint";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new PrivateLinkEndpointEntity($this->_client, $opts);
    }

    /**
     * @param PrivateLinkEndpoint|array $args PrivateLinkEndpoint data (assoc-array) to store.
     */
    ...
    /**
     * @return PrivateLinkEndpoint|array The current PrivateLinkEndpoint data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of PrivateLinkEndpoint fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of PrivateLinkEndpoint fields).
     */
    ...
    /**
     * Load a single PrivateLinkEndpoint.
     *
     * @param PrivateLinkEndpointLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PrivateLinkEndpointLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateLinkEndpoint|array The loaded PrivateLinkEndpoint as an assoc-array at the
    ...
    /**
     * List PrivateLinkEndpoint items matching the given filter.
     *
     * @param PrivateLinkEndpointListMatch|array|null $reqmatch Match filter (any subset
     *   of PrivateLinkEndpoint fields) as an assoc-array; PrivateLinkEndpointListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateLinkEndpoint[]|array A list of PrivateLinkEndpoint items as assoc-arrays at
    ...
    /**
     * Create a new PrivateLinkEndpoint.
     *
     * @param PrivateLinkEndpointCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PrivateLinkEndpointCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateLinkEndpoint|array The created PrivateLinkEndpoint as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing PrivateLinkEndpoint.
     *
     * @param PrivateLinkEndpointUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PrivateLinkEndpointUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return PrivateLinkEndpoint|array The updated PrivateLinkEndpoint as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
