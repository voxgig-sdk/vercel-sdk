...
class DeploymentEntity
{
     ...
     *
     * @param DeploymentUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DeploymentUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Deployment|array The updated Deployment as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
