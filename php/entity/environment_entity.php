...
class EnvironmentEntity
{
    ...
    /**
     * List Environment items matching the given filter.
     *
     * @param EnvironmentListMatch|array|null $reqmatch Match filter (any subset
     *   of Environment fields) as an assoc-array; EnvironmentListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Environment[]|array A list of Environment items as assoc-arrays at
