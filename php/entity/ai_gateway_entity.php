...
class AiGatewayEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AiGatewayEntity($this->_client, $opts);
    }

    /**
     * @param AiGateway|array $args AiGateway data (assoc-array) to store.
     */
    ...
    /**
     * @return AiGateway|array The current AiGateway data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiGateway fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiGateway fields).
     */
    ...
    /**
     * Remove an AiGateway matching the given criteria.
     *
     * @param AiGatewayRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AiGatewayRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGateway|array The removed AiGateway as an assoc-array at the
