...
class AccessGroupEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AccessGroupEntity($this->_client, $opts);
    }

    /**
     * @param AccessGroup|array $args AccessGroup data (assoc-array) to store.
     */
    ...
    /**
     * @return AccessGroup|array The current AccessGroup data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AccessGroup fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AccessGroup fields).
     */
    ...
    /**
     * Load a single AccessGroup.
     *
     * @param AccessGroupLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AccessGroupLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccessGroup|array The loaded AccessGroup as an assoc-array at the
    ...
    /**
     * List AccessGroup items matching the given filter.
     *
     * @param AccessGroupListMatch|array|null $reqmatch Match filter (any subset
     *   of AccessGroup fields) as an assoc-array; AccessGroupListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccessGroup[]|array A list of AccessGroup items as assoc-arrays at
     ...
     *
     * @param AccessGroupCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AccessGroupCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccessGroup|array The created AccessGroup as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing AccessGroup.
     *
     * @param AccessGroupUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AccessGroupUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccessGroup|array The updated AccessGroup as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an AccessGroup matching the given criteria.
     *
     * @param AccessGroupRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; AccessGroupRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AccessGroup|array The removed AccessGroup as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
