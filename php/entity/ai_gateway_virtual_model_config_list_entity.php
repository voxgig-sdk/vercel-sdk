...
class AiGatewayVirtualModelConfigListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ai_gateway_virtual_model_config_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AiGatewayVirtualModelConfigListEntity($this->_client, $opts);
    }

    /**
     * @param AiGatewayVirtualModelConfigList|array $args AiGatewayVirtualModelConfigList data (assoc-array) to store.
     */
    ...
    /**
     * @return AiGatewayVirtualModelConfigList|array The current AiGatewayVirtualModelConfigList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiGatewayVirtualModelConfigList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiGatewayVirtualModelConfigList fields).
     */
    ...
    /**
     * List AiGatewayVirtualModelConfigList items matching the given filter.
     *
     * @param AiGatewayVirtualModelConfigListListMatch|array|null $reqmatch Match filter (any subset
     *   of AiGatewayVirtualModelConfigList fields) as an assoc-array; AiGatewayVirtualModelConfigListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGatewayVirtualModelConfigList[]|array A list of AiGatewayVirtualModelConfigList items as assoc-arrays at
