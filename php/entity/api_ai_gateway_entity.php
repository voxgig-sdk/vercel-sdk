...
// Vercel SDK ApiAiGateway entity
...
class ApiAiGatewayEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ApiAiGatewayEntity($this->_client, $opts);
    }

    /**
     * @param ApiAiGateway|array $args ApiAiGateway data (assoc-array) to store.
     */
    ...
    /**
     * @return ApiAiGateway|array The current ApiAiGateway data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ApiAiGateway fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ApiAiGateway fields).
     */
    ...
    /**
     * Load a single ApiAiGateway.
     *
     * @param ApiAiGatewayLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ApiAiGatewayLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiAiGateway|array The loaded ApiAiGateway as an assoc-array at the
    ...
    /**
     * Remove an ApiAiGateway matching the given criteria.
     *
     * @param ApiAiGatewayRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ApiAiGatewayRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ApiAiGateway|array The removed ApiAiGateway as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
