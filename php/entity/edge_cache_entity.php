...
class EdgeCacheEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EdgeCacheEntity($this->_client, $opts);
    }

    /**
     * @param EdgeCache|array $args EdgeCache data (assoc-array) to store.
     */
    ...
    /**
     * @return EdgeCache|array The current EdgeCache data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of EdgeCache fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of EdgeCache fields).
     */
    ...
    /**
     * Create a new EdgeCache.
     *
     * @param EdgeCacheCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EdgeCacheCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return EdgeCache|array The created EdgeCache as an assoc-array at the
