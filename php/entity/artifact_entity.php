...
class ArtifactEntity
{
     ...
     *
     * @param ArtifactCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ArtifactCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Artifact|array The created Artifact as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param ArtifactUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ArtifactUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Artifact|array The updated Artifact as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Artifact matching the given criteria.
     *
     * @param ArtifactRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ArtifactRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Artifact|array The removed Artifact as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
