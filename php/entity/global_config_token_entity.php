...
class GlobalConfigTokenEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "global_config_token";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new GlobalConfigTokenEntity($this->_client, $opts);
    }

    /**
     * @param GlobalConfigToken|array $args GlobalConfigToken data (assoc-array) to store.
     */
    ...
    /**
     * @return GlobalConfigToken|array The current GlobalConfigToken data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of GlobalConfigToken fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of GlobalConfigToken fields).
     */
    ...
    /**
     * Load a single GlobalConfigToken.
     *
     * @param GlobalConfigTokenLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed GlobalConfigTokenLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return GlobalConfigToken|array The loaded GlobalConfigToken as an assoc-array at the
