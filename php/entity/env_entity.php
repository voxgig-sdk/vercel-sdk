...
class EnvEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EnvEntity($this->_client, $opts);
    }

    /**
     * @param Env|array $args Env data (assoc-array) to store.
     */
    ...
    /**
     * @return Env|array The current Env data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Env fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Env fields).
     */
     ...
     * Load a single Env.
     *
     * @param EnvLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EnvLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Env|array The loaded Env as an assoc-array at the
    ...
    /**
     * List Env items matching the given filter.
     *
     * @param EnvListMatch|array|null $reqmatch Match filter (any subset
     *   of Env fields) as an assoc-array; EnvListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Env[]|array A list of Env items as assoc-arrays at
     ...
     * Create a new Env.
     *
     * @param EnvCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnvCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Env|array The created Env as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param EnvUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed EnvUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Env|array The updated Env as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Env matching the given criteria.
     *
     * @param EnvRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; EnvRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Env|array The removed Env as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
