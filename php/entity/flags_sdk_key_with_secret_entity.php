...
class FlagsSdkKeyWithSecretEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "flags_sdk_key_with_secret";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new FlagsSdkKeyWithSecretEntity($this->_client, $opts);
    }

    /**
     * @param FlagsSdkKeyWithSecret|array $args FlagsSdkKeyWithSecret data (assoc-array) to store.
     */
    ...
    /**
     * @return FlagsSdkKeyWithSecret|array The current FlagsSdkKeyWithSecret data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FlagsSdkKeyWithSecret fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FlagsSdkKeyWithSecret fields).
     */
    ...
    /**
     * Update an existing FlagsSdkKeyWithSecret.
     *
     * @param FlagsSdkKeyWithSecretUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed FlagsSdkKeyWithSecretUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FlagsSdkKeyWithSecret|array The updated FlagsSdkKeyWithSecret as an assoc-array at the
