...
class QueryEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new QueryEntity($this->_client, $opts);
    }

    /**
     * @param Query|array $args Query data (assoc-array) to store.
     */
    ...
    /**
     * @return Query|array The current Query data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Query fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Query fields).
     */
     ...
     * Create a new Query.
     *
     * @param QueryCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed QueryCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Query|array The created Query as an assoc-array at the
