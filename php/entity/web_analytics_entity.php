...
class WebAnalyticsEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WebAnalyticsEntity($this->_client, $opts);
    }

    /**
     * @param WebAnalytics|array $args WebAnalytics data (assoc-array) to store.
     */
    ...
    /**
     * @return WebAnalytics|array The current WebAnalytics data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of WebAnalytics fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of WebAnalytics fields).
     */
    ...
    /**
     * Load a single WebAnalytics.
     *
     * @param WebAnalyticsLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WebAnalyticsLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return WebAnalytics|array The loaded WebAnalytics as an assoc-array at the
