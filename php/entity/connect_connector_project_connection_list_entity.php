...
class ConnectConnectorProjectConnectionListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "connect_connector_project_connection_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConnectConnectorProjectConnectionListEntity($this->_client, $opts);
    }

    /**
     * @param ConnectConnectorProjectConnectionList|array $args ConnectConnectorProjectConnectionList data (assoc-array) to store.
     */
    ...
    /**
     * @return ConnectConnectorProjectConnectionList|array The current ConnectConnectorProjectConnectionList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConnectConnectorProjectConnectionList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConnectConnectorProjectConnectionList fields).
     */
    ...
    /**
     * List ConnectConnectorProjectConnectionList items matching the given filter.
     *
     * @param ConnectConnectorProjectConnectionListListMatch|array|null $reqmatch Match filter (any subset
     *   of ConnectConnectorProjectConnectionList fields) as an assoc-array; ConnectConnectorProjectConnectionListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectConnectorProjectConnectionList[]|array A list of ConnectConnectorProjectConnectionList items as assoc-arrays at
