...
// Vercel SDK ProjectMember entity
...
class ProjectMemberEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ProjectMemberEntity($this->_client, $opts);
    }

    /**
     * @param ProjectMember|array $args ProjectMember data (assoc-array) to store.
     */
    ...
    /**
     * @return ProjectMember|array The current ProjectMember data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ProjectMember fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ProjectMember fields).
     */
    ...
    /**
     * Load a single ProjectMember.
     *
     * @param ProjectMemberLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ProjectMemberLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectMember|array The loaded ProjectMember as an assoc-array at the
     ...
     *
     * @param ProjectMemberCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ProjectMemberCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectMember|array The created ProjectMember as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an ProjectMember matching the given criteria.
     *
     * @param ProjectMemberRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ProjectMemberRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ProjectMember|array The removed ProjectMember as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
