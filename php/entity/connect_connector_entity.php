...
// Vercel SDK ConnectConnector entity
...
class ConnectConnectorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ConnectConnectorEntity($this->_client, $opts);
    }

    /**
     * @param ConnectConnector|array $args ConnectConnector data (assoc-array) to store.
     */
    ...
    /**
     * @return ConnectConnector|array The current ConnectConnector data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConnectConnector fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConnectConnector fields).
     */
    ...
    /**
     * Load a single ConnectConnector.
     *
     * @param ConnectConnectorLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConnectConnectorLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectConnector|array The loaded ConnectConnector as an assoc-array at the
    ...
    /**
     * Create a new ConnectConnector.
     *
     * @param ConnectConnectorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConnectConnectorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectConnector|array The created ConnectConnector as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing ConnectConnector.
     *
     * @param ConnectConnectorUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConnectConnectorUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectConnector|array The updated ConnectConnector as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
