...
class ConnectProjectConnectionEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "connect_project_connection";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConnectProjectConnectionEntity($this->_client, $opts);
    }

    /**
     * @param ConnectProjectConnection|array $args ConnectProjectConnection data (assoc-array) to store.
     */
    ...
    /**
     * @return ConnectProjectConnection|array The current ConnectProjectConnection data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConnectProjectConnection fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConnectProjectConnection fields).
     */
    ...
    /**
     * Load a single ConnectProjectConnection.
     *
     * @param ConnectProjectConnectionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ConnectProjectConnectionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectProjectConnection|array The loaded ConnectProjectConnection as an assoc-array at the
    ...
    /**
     * Create a new ConnectProjectConnection.
     *
     * @param ConnectProjectConnectionCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ConnectProjectConnectionCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectProjectConnection|array The created ConnectProjectConnection as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
