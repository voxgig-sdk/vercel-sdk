...
// Vercel SDK RollingRelease entity
...
class RollingReleaseEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RollingReleaseEntity($this->_client, $opts);
    }

    /**
     * @param RollingRelease|array $args RollingRelease data (assoc-array) to store.
     */
    ...
    /**
     * @return RollingRelease|array The current RollingRelease data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of RollingRelease fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of RollingRelease fields).
     */
    ...
    /**
     * Load a single RollingRelease.
     *
     * @param RollingReleaseLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RollingReleaseLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RollingRelease|array The loaded RollingRelease as an assoc-array at the
    ...
    /**
     * Create a new RollingRelease.
     *
     * @param RollingReleaseCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RollingReleaseCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RollingRelease|array The created RollingRelease as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing RollingRelease.
     *
     * @param RollingReleaseUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed RollingReleaseUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RollingRelease|array The updated RollingRelease as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an RollingRelease matching the given criteria.
     *
     * @param RollingReleaseRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; RollingReleaseRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return RollingRelease|array The removed RollingRelease as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
