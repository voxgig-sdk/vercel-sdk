...
class VcrRepositoryPermissionListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "vcr_repository_permission_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new VcrRepositoryPermissionListEntity($this->_client, $opts);
    }

    /**
     * @param VcrRepositoryPermissionList|array $args VcrRepositoryPermissionList data (assoc-array) to store.
     */
    ...
    /**
     * @return VcrRepositoryPermissionList|array The current VcrRepositoryPermissionList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of VcrRepositoryPermissionList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of VcrRepositoryPermissionList fields).
     */
    ...
    /**
     * List VcrRepositoryPermissionList items matching the given filter.
     *
     * @param VcrRepositoryPermissionListListMatch|array|null $reqmatch Match filter (any subset
     *   of VcrRepositoryPermissionList fields) as an assoc-array; VcrRepositoryPermissionListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return VcrRepositoryPermissionList[]|array A list of VcrRepositoryPermissionList items as assoc-arrays at
