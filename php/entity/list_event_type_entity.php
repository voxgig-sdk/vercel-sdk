...
class ListEventTypeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ListEventTypeEntity($this->_client, $opts);
    }

    /**
     * @param ListEventType|array $args ListEventType data (assoc-array) to store.
     */
    ...
    /**
     * @return ListEventType|array The current ListEventType data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ListEventType fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ListEventType fields).
     */
    ...
    /**
     * List ListEventType items matching the given filter.
     *
     * @param ListEventTypeListMatch|array|null $reqmatch Match filter (any subset
     *   of ListEventType fields) as an assoc-array; ListEventTypeListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ListEventType[]|array A list of ListEventType items as assoc-arrays at
