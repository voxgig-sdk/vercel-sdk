...
// Vercel SDK Microfrontend entity
...
class MicrofrontendEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MicrofrontendEntity($this->_client, $opts);
    }

    /**
     * @param Microfrontend|array $args Microfrontend data (assoc-array) to store.
     */
    ...
    /**
     * @return Microfrontend|array The current Microfrontend data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Microfrontend fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Microfrontend fields).
     */
    ...
    /**
     * Load a single Microfrontend.
     *
     * @param MicrofrontendLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed MicrofrontendLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Microfrontend|array The loaded Microfrontend as an assoc-array at the
    ...
    /**
     * List Microfrontend items matching the given filter.
     *
     * @param MicrofrontendListMatch|array|null $reqmatch Match filter (any subset
     *   of Microfrontend fields) as an assoc-array; MicrofrontendListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Microfrontend[]|array A list of Microfrontend items as assoc-arrays at
     ...
     *
     * @param MicrofrontendCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MicrofrontendCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Microfrontend|array The created Microfrontend as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
