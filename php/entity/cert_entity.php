...
class CertEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CertEntity($this->_client, $opts);
    }

    /**
     * @param Cert|array $args Cert data (assoc-array) to store.
     */
    ...
    /**
     * @return Cert|array The current Cert data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cert fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cert fields).
     */
     ...
     * Load a single Cert.
     *
     * @param CertLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CertLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cert|array The loaded Cert as an assoc-array at the
    ...
    /**
     * List Cert items matching the given filter.
     *
     * @param CertListMatch|array|null $reqmatch Match filter (any subset
     *   of Cert fields) as an assoc-array; CertListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cert[]|array A list of Cert items as assoc-arrays at
     ...
     * Create a new Cert.
     *
     * @param CertCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CertCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cert|array The created Cert as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param CertUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CertUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cert|array The updated Cert as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Cert matching the given criteria.
     *
     * @param CertRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; CertRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cert|array The removed Cert as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
