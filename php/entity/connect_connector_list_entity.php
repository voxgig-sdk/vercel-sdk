...
class ConnectConnectorListEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "connect_connector_list";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new ConnectConnectorListEntity($this->_client, $opts);
    }

    /**
     * @param ConnectConnectorList|array $args ConnectConnectorList data (assoc-array) to store.
     */
    ...
    /**
     * @return ConnectConnectorList|array The current ConnectConnectorList data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of ConnectConnectorList fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of ConnectConnectorList fields).
     */
    ...
    /**
     * List ConnectConnectorList items matching the given filter.
     *
     * @param ConnectConnectorListListMatch|array|null $reqmatch Match filter (any subset
     *   of ConnectConnectorList fields) as an assoc-array; ConnectConnectorListListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return ConnectConnectorList[]|array A list of ConnectConnectorList items as assoc-arrays at
