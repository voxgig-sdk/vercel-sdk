...
// Vercel SDK AiGatewayVirtualModelConfig entity
...
class AiGatewayVirtualModelConfigEntity
{
    ...
    public function __construct($client, ?array $entopts = null)
    {
        ...
        $this->_name = "ai_gateway_virtual_model_config";
        $this->_client = $client;
    ...
    {
        $opts = $this->_entopts;
        return new AiGatewayVirtualModelConfigEntity($this->_client, $opts);
    }

    /**
     * @param AiGatewayVirtualModelConfig|array $args AiGatewayVirtualModelConfig data (assoc-array) to store.
     */
    ...
    /**
     * @return AiGatewayVirtualModelConfig|array The current AiGatewayVirtualModelConfig data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of AiGatewayVirtualModelConfig fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of AiGatewayVirtualModelConfig fields).
     */
    ...
    /**
     * Load a single AiGatewayVirtualModelConfig.
     *
     * @param AiGatewayVirtualModelConfigLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AiGatewayVirtualModelConfigLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGatewayVirtualModelConfig|array The loaded AiGatewayVirtualModelConfig as an assoc-array at the
    ...
    /**
     * Create a new AiGatewayVirtualModelConfig.
     *
     * @param AiGatewayVirtualModelConfigCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiGatewayVirtualModelConfigCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGatewayVirtualModelConfig|array The created AiGatewayVirtualModelConfig as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Update an existing AiGatewayVirtualModelConfig.
     *
     * @param AiGatewayVirtualModelConfigUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed AiGatewayVirtualModelConfigUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return AiGatewayVirtualModelConfig|array The updated AiGatewayVirtualModelConfig as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
