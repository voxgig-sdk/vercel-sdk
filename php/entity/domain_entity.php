...
class DomainEntity
{
     ...
     * Create a new Domain.
     *
     * @param DomainCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DomainCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Domain|array The created Domain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
     ...
     *
     * @param DomainUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed DomainUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Domain|array The updated Domain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Domain matching the given criteria.
     *
     * @param DomainRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; DomainRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Domain|array The removed Domain as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
