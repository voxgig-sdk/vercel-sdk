...
class FlagEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FlagEntity($this->_client, $opts);
    }

    /**
     * @param Flag|array $args Flag data (assoc-array) to store.
     */
    ...
    /**
     * @return Flag|array The current Flag data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Flag fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Flag fields).
     */
     ...
     * Load a single Flag.
     *
     * @param FlagLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FlagLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Flag|array The loaded Flag as an assoc-array at the
