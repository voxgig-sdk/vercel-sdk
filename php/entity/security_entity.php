...
class SecurityEntity
{
     ...
     *
     * @param SecurityLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SecurityLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Security|array The loaded Security as an assoc-array at the
    ...
    /**
     * List Security items matching the given filter.
     *
     * @param SecurityListMatch|array|null $reqmatch Match filter (any subset
     *   of Security fields) as an assoc-array; SecurityListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Security[]|array A list of Security items as assoc-arrays at
     ...
     *
     * @param SecurityUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed SecurityUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Security|array The updated Security as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
    ...
    /**
     * Remove an Security matching the given criteria.
     *
     * @param SecurityRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; SecurityRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Security|array The removed Security as an assoc-array at the
     *   SDK boundary; throws VercelError on failure (item-5 convention).
     */
