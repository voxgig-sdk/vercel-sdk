...
class VercelRatelimitFeature extends VercelBaseFeature
{
    ...
    private function _acquire(VercelContext $ctx): void
    {
    ...
    private function _track(VercelContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
