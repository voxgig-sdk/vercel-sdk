...
class VercelTimeoutFeature extends VercelBaseFeature
{
    ...
    private function _with_timeout(VercelContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VercelContext $_ctx, float $ms): void
    {
        $client = $this->client;
