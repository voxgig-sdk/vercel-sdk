...
local ConnectConnectorEntity = {}
ConnectConnectorEntity.__index = ConnectConnectorEntity


function ConnectConnectorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConnectConnectorEntity)
  self._name = "connect_connector"
  self._client = client
...
function ConnectConnectorEntity:get_name()
  return self._name
end


function ConnectConnectorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConnectConnectorEntity.new(self._client, opts)
end
...
function ConnectConnectorEntity:mark_deleted()
  self._deleted = true
end


function ConnectConnectorEntity:deleted()
  return true == self._deleted
end


function ConnectConnectorEntity:data_set(args)
  if args ~= nil then
...
function ConnectConnectorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConnectConnectorEntity:match_set(args)
  if args ~= nil then
...
function ConnectConnectorEntity:match_get()
...
function ConnectConnectorEntity:stream(action, args, callopts)
...
---@param reqmatch ConnectConnectorLoadMatch
---@param ctrl? table
---@return ConnectConnector
---@return string? err
function ConnectConnectorEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConnectConnectorCreateData
---@param ctrl? table
---@return ConnectConnector
---@return string? err
function ConnectConnectorEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ConnectConnectorUpdateData
---@param ctrl? table
---@return ConnectConnector
---@return string? err
function ConnectConnectorEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ConnectConnectorEntity:_run_op(ctx, post_done)
  local utility = self._utility
