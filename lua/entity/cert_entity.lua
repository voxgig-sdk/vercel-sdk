...
local CertEntity = {}
CertEntity.__index = CertEntity


function CertEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CertEntity)
  self._name = "cert"
  self._client = client
...
function CertEntity:get_name()
  return self._name
end


function CertEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CertEntity.new(self._client, opts)
end
...
function CertEntity:mark_deleted()
  self._deleted = true
end


function CertEntity:deleted()
  return true == self._deleted
end


function CertEntity:data_set(args)
  if args ~= nil then
...
function CertEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CertEntity:match_set(args)
  if args ~= nil then
...
function CertEntity:stream(action, args, callopts)
...
---@param reqmatch CertLoadMatch
---@param ctrl? table
---@return Cert
---@return string? err
function CertEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch CertListMatch
---@param ctrl? table
---@return Cert[]
---@return string? err
function CertEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata CertCreateData
---@param ctrl? table
---@return Cert
---@return string? err
function CertEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata CertUpdateData
---@param ctrl? table
---@return Cert
---@return string? err
function CertEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch CertRemoveMatch
---@param ctrl? table
---@return Cert
---@return string? err
function CertEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function CertEntity:_run_op(ctx, post_done)
  local utility = self._utility
