-- Vercel SDK ListEventType entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ListEventTypeEntity = {}
ListEventTypeEntity.__index = ListEventTypeEntity


function ListEventTypeEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ListEventTypeEntity)
  self._name = "list_event_type"
  self._client = client
...
function ListEventTypeEntity:get_name()
  return self._name
end


function ListEventTypeEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ListEventTypeEntity.new(self._client, opts)
end
...
function ListEventTypeEntity:mark_deleted()
  self._deleted = true
end


function ListEventTypeEntity:deleted()
  return true == self._deleted
end


function ListEventTypeEntity:data_set(args)
  if args ~= nil then
...
function ListEventTypeEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ListEventTypeEntity:match_set(args)
  if args ~= nil then
...
function ListEventTypeEntity:match_get()
...
function ListEventTypeEntity:stream(action, args, callopts)
...
---@param reqmatch ListEventTypeListMatch
---@param ctrl? table
---@return ListEventType[]
---@return string? err
function ListEventTypeEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ListEventTypeEntity:_run_op(ctx, post_done)
  local utility = self._utility
