...
---@param reqdata DomainCreateData
---@param ctrl? table
---@return Domain
---@return string? err
function DomainEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DomainUpdateData
---@param ctrl? table
---@return Domain
---@return string? err
function DomainEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch DomainRemoveMatch
---@param ctrl? table
---@return Domain
---@return string? err
function DomainEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
