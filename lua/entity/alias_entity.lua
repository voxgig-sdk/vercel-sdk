...
local AliasEntity = {}
AliasEntity.__index = AliasEntity


function AliasEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AliasEntity)
  self._name = "alias"
  self._client = client
...
function AliasEntity:get_name()
  return self._name
end


function AliasEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AliasEntity.new(self._client, opts)
end
...
function AliasEntity:mark_deleted()
  self._deleted = true
end


function AliasEntity:deleted()
  return true == self._deleted
end


function AliasEntity:data_set(args)
  if args ~= nil then
...
function AliasEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AliasEntity:match_set(args)
  if args ~= nil then
...
function AliasEntity:match_get()
...
function AliasEntity:stream(action, args, callopts)
...
---@param reqmatch AliasLoadMatch
---@param ctrl? table
---@return Alias
---@return string? err
function AliasEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch AliasListMatch
---@param ctrl? table
---@return Alias[]
---@return string? err
function AliasEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata AliasCreateData
---@param ctrl? table
---@return Alias
---@return string? err
function AliasEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AliasUpdateData
---@param ctrl? table
---@return Alias
---@return string? err
function AliasEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch AliasRemoveMatch
---@param ctrl? table
---@return Alias
---@return string? err
function AliasEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AliasEntity:_run_op(ctx, post_done)
  local utility = self._utility
