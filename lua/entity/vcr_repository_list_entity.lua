-- Vercel SDK VcrRepositoryList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local VcrRepositoryListEntity = {}
VcrRepositoryListEntity.__index = VcrRepositoryListEntity


function VcrRepositoryListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VcrRepositoryListEntity)
  self._name = "vcr_repository_list"
  self._client = client
...
function VcrRepositoryListEntity:get_name()
  return self._name
end


function VcrRepositoryListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VcrRepositoryListEntity.new(self._client, opts)
end
...
function VcrRepositoryListEntity:mark_deleted()
  self._deleted = true
end


function VcrRepositoryListEntity:deleted()
  return true == self._deleted
end


function VcrRepositoryListEntity:data_set(args)
  if args ~= nil then
...
function VcrRepositoryListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VcrRepositoryListEntity:match_set(args)
  if args ~= nil then
...
function VcrRepositoryListEntity:match_get()
...
function VcrRepositoryListEntity:stream(action, args, callopts)
...
---@param reqmatch VcrRepositoryListListMatch
---@param ctrl? table
---@return VcrRepositoryList[]
---@return string? err
function VcrRepositoryListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function VcrRepositoryListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return VcrRepositoryListEntity
