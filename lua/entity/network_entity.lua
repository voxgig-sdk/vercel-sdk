...
---@param reqdata NetworkCreateData
---@param ctrl? table
---@return Network
---@return string? err
function NetworkEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata NetworkUpdateData
---@param ctrl? table
---@return Network
---@return string? err
function NetworkEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch NetworkRemoveMatch
---@param ctrl? table
---@return Network
---@return string? err
function NetworkEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
