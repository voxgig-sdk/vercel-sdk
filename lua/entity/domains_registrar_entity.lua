...
local DomainsRegistrarEntity = {}
DomainsRegistrarEntity.__index = DomainsRegistrarEntity


function DomainsRegistrarEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DomainsRegistrarEntity)
  self._name = "domains_registrar"
  self._client = client
...
function DomainsRegistrarEntity:get_name()
  return self._name
end


function DomainsRegistrarEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DomainsRegistrarEntity.new(self._client, opts)
end
...
function DomainsRegistrarEntity:mark_deleted()
  self._deleted = true
end


function DomainsRegistrarEntity:deleted()
  return true == self._deleted
end


function DomainsRegistrarEntity:data_set(args)
  if args ~= nil then
...
function DomainsRegistrarEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DomainsRegistrarEntity:match_set(args)
  if args ~= nil then
...
function DomainsRegistrarEntity:match_get()
...
function DomainsRegistrarEntity:stream(action, args, callopts)
...
---@param reqmatch DomainsRegistrarLoadMatch
---@param ctrl? table
---@return DomainsRegistrar
---@return string? err
function DomainsRegistrarEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata DomainsRegistrarCreateData
---@param ctrl? table
---@return DomainsRegistrar
---@return string? err
function DomainsRegistrarEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DomainsRegistrarUpdateData
---@param ctrl? table
---@return DomainsRegistrar
---@return string? err
function DomainsRegistrarEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function DomainsRegistrarEntity:_run_op(ctx, post_done)
  local utility = self._utility
