...
local ProjectRouteEntity = {}
ProjectRouteEntity.__index = ProjectRouteEntity


function ProjectRouteEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProjectRouteEntity)
  self._name = "project_route"
  self._client = client
...
function ProjectRouteEntity:get_name()
  return self._name
end


function ProjectRouteEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProjectRouteEntity.new(self._client, opts)
end
...
function ProjectRouteEntity:mark_deleted()
  self._deleted = true
end


function ProjectRouteEntity:deleted()
  return true == self._deleted
end


function ProjectRouteEntity:data_set(args)
  if args ~= nil then
...
function ProjectRouteEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProjectRouteEntity:match_set(args)
  if args ~= nil then
...
function ProjectRouteEntity:match_get()
...
function ProjectRouteEntity:stream(action, args, callopts)
...
---@param reqmatch ProjectRouteLoadMatch
---@param ctrl? table
---@return ProjectRoute
---@return string? err
function ProjectRouteEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ProjectRouteListMatch
---@param ctrl? table
---@return ProjectRoute[]
---@return string? err
function ProjectRouteEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ProjectRouteCreateData
---@param ctrl? table
---@return ProjectRoute
---@return string? err
function ProjectRouteEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ProjectRouteUpdateData
---@param ctrl? table
---@return ProjectRoute
---@return string? err
function ProjectRouteEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ProjectRouteRemoveMatch
---@param ctrl? table
---@return ProjectRoute
---@return string? err
function ProjectRouteEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ProjectRouteEntity:_run_op(ctx, post_done)
  local utility = self._utility
