-- Vercel SDK AiGatewayVirtualModelConfigList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local AiGatewayVirtualModelConfigListEntity = {}
AiGatewayVirtualModelConfigListEntity.__index = AiGatewayVirtualModelConfigListEntity


function AiGatewayVirtualModelConfigListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AiGatewayVirtualModelConfigListEntity)
  self._name = "ai_gateway_virtual_model_config_list"
  self._client = client
...
function AiGatewayVirtualModelConfigListEntity:get_name()
  return self._name
end


function AiGatewayVirtualModelConfigListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AiGatewayVirtualModelConfigListEntity.new(self._client, opts)
end
...
function AiGatewayVirtualModelConfigListEntity:mark_deleted()
  self._deleted = true
end


function AiGatewayVirtualModelConfigListEntity:deleted()
  return true == self._deleted
end


function AiGatewayVirtualModelConfigListEntity:data_set(args)
  if args ~= nil then
...
function AiGatewayVirtualModelConfigListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AiGatewayVirtualModelConfigListEntity:match_set(args)
  if args ~= nil then
...
function AiGatewayVirtualModelConfigListEntity:match_get()
...
function AiGatewayVirtualModelConfigListEntity:stream(action, args, callopts)
...
---@param reqmatch AiGatewayVirtualModelConfigListListMatch
---@param ctrl? table
---@return AiGatewayVirtualModelConfigList[]
---@return string? err
function AiGatewayVirtualModelConfigListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function AiGatewayVirtualModelConfigListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AiGatewayVirtualModelConfigListEntity
