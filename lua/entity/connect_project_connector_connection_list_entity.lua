-- Vercel SDK ConnectProjectConnectorConnectionList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConnectProjectConnectorConnectionListEntity = {}
ConnectProjectConnectorConnectionListEntity.__index = ConnectProjectConnectorConnectionListEntity


function ConnectProjectConnectorConnectionListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConnectProjectConnectorConnectionListEntity)
  self._name = "connect_project_connector_connection_list"
  self._client = client
...
function ConnectProjectConnectorConnectionListEntity:get_name()
  return self._name
end


function ConnectProjectConnectorConnectionListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConnectProjectConnectorConnectionListEntity.new(self._client, opts)
end
...
function ConnectProjectConnectorConnectionListEntity:mark_deleted()
  self._deleted = true
end


function ConnectProjectConnectorConnectionListEntity:deleted()
  return true == self._deleted
end


function ConnectProjectConnectorConnectionListEntity:data_set(args)
  if args ~= nil then
...
function ConnectProjectConnectorConnectionListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConnectProjectConnectorConnectionListEntity:match_set(args)
  if args ~= nil then
...
function ConnectProjectConnectorConnectionListEntity:match_get()
...
function ConnectProjectConnectorConnectionListEntity:stream(action, args, callopts)
...
---@param reqmatch ConnectProjectConnectorConnectionListListMatch
---@param ctrl? table
---@return ConnectProjectConnectorConnectionList[]
---@return string? err
function ConnectProjectConnectorConnectionListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConnectProjectConnectorConnectionListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConnectProjectConnectorConnectionListEntity
