-- Vercel SDK ConnectConnectorList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConnectConnectorListEntity = {}
ConnectConnectorListEntity.__index = ConnectConnectorListEntity


function ConnectConnectorListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConnectConnectorListEntity)
  self._name = "connect_connector_list"
  self._client = client
...
function ConnectConnectorListEntity:get_name()
  return self._name
end


function ConnectConnectorListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConnectConnectorListEntity.new(self._client, opts)
end
...
function ConnectConnectorListEntity:mark_deleted()
  self._deleted = true
end


function ConnectConnectorListEntity:deleted()
  return true == self._deleted
end


function ConnectConnectorListEntity:data_set(args)
  if args ~= nil then
...
function ConnectConnectorListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConnectConnectorListEntity:match_set(args)
  if args ~= nil then
...
function ConnectConnectorListEntity:match_get()
...
function ConnectConnectorListEntity:stream(action, args, callopts)
...
---@param reqmatch ConnectConnectorListListMatch
---@param ctrl? table
---@return ConnectConnectorList[]
---@return string? err
function ConnectConnectorListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConnectConnectorListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConnectConnectorListEntity
