...
local MarketplaceEntity = {}
MarketplaceEntity.__index = MarketplaceEntity


function MarketplaceEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MarketplaceEntity)
...
function MarketplaceEntity:get_name()
  return self._name
end


function MarketplaceEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MarketplaceEntity.new(self._client, opts)
end
...
function MarketplaceEntity:mark_deleted()
  self._deleted = true
end


function MarketplaceEntity:deleted()
  return true == self._deleted
end


function MarketplaceEntity:data_set(args)
  if args ~= nil then
...
function MarketplaceEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MarketplaceEntity:match_set(args)
  if args ~= nil then
...
function MarketplaceEntity:match_get()
...
function MarketplaceEntity:stream(action, args, callopts)
...
---@param reqmatch MarketplaceLoadMatch
---@param ctrl? table
---@return Marketplace
---@return string? err
function MarketplaceEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MarketplaceListMatch
---@param ctrl? table
---@return Marketplace[]
---@return string? err
function MarketplaceEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata MarketplaceCreateData
---@param ctrl? table
---@return Marketplace
---@return string? err
function MarketplaceEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata MarketplaceUpdateData
---@param ctrl? table
---@return Marketplace
---@return string? err
function MarketplaceEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch MarketplaceRemoveMatch
---@param ctrl? table
---@return Marketplace
---@return string? err
function MarketplaceEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function MarketplaceEntity:_run_op(ctx, post_done)
  local utility = self._utility
