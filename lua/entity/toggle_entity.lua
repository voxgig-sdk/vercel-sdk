-- Vercel SDK Toggle entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ToggleEntity = {}
ToggleEntity.__index = ToggleEntity


function ToggleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ToggleEntity)
  self._name = "toggle"
  self._client = client
...
function ToggleEntity:get_name()
  return self._name
end


function ToggleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ToggleEntity.new(self._client, opts)
end
...
function ToggleEntity:mark_deleted()
  self._deleted = true
end


function ToggleEntity:deleted()
  return true == self._deleted
end


function ToggleEntity:data_set(args)
  if args ~= nil then
...
function ToggleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ToggleEntity:match_set(args)
  if args ~= nil then
...
function ToggleEntity:match_get()
...
function ToggleEntity:stream(action, args, callopts)
...
---@param reqdata ToggleCreateData
---@param ctrl? table
---@return Toggle
---@return string? err
function ToggleEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function ToggleEntity:_run_op(ctx, post_done)
  local utility = self._utility
