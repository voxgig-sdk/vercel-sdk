...
local LogDrainEntity = {}
LogDrainEntity.__index = LogDrainEntity


function LogDrainEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LogDrainEntity)
  self._name = "log_drain"
  self._client = client
...
function LogDrainEntity:get_name()
  return self._name
end


function LogDrainEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LogDrainEntity.new(self._client, opts)
end
...
function LogDrainEntity:mark_deleted()
  self._deleted = true
end


function LogDrainEntity:deleted()
  return true == self._deleted
end


function LogDrainEntity:data_set(args)
  if args ~= nil then
...
function LogDrainEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LogDrainEntity:match_set(args)
  if args ~= nil then
...
function LogDrainEntity:match_get()
...
function LogDrainEntity:stream(action, args, callopts)
...
---@param reqmatch LogDrainLoadMatch
---@param ctrl? table
---@return LogDrain
---@return string? err
function LogDrainEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch LogDrainListMatch
---@param ctrl? table
---@return LogDrain[]
---@return string? err
function LogDrainEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata LogDrainCreateData
---@param ctrl? table
---@return LogDrain
---@return string? err
function LogDrainEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch LogDrainRemoveMatch
---@param ctrl? table
---@return LogDrain
---@return string? err
function LogDrainEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function LogDrainEntity:_run_op(ctx, post_done)
  local utility = self._utility
