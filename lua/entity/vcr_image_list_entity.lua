-- Vercel SDK VcrImageList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local VcrImageListEntity = {}
VcrImageListEntity.__index = VcrImageListEntity


function VcrImageListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VcrImageListEntity)
  self._name = "vcr_image_list"
  self._client = client
...
function VcrImageListEntity:get_name()
  return self._name
end


function VcrImageListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VcrImageListEntity.new(self._client, opts)
end
...
function VcrImageListEntity:mark_deleted()
  self._deleted = true
end


function VcrImageListEntity:deleted()
  return true == self._deleted
end


function VcrImageListEntity:data_set(args)
  if args ~= nil then
...
function VcrImageListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VcrImageListEntity:match_set(args)
  if args ~= nil then
...
function VcrImageListEntity:match_get()
...
function VcrImageListEntity:stream(action, args, callopts)
...
---@param reqmatch VcrImageListListMatch
---@param ctrl? table
---@return VcrImageList[]
---@return string? err
function VcrImageListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function VcrImageListEntity:_run_op(ctx, post_done)
  local utility = self._utility
