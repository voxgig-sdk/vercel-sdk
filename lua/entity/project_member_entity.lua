...
local ProjectMemberEntity = {}
ProjectMemberEntity.__index = ProjectMemberEntity


function ProjectMemberEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ProjectMemberEntity)
  self._name = "project_member"
  self._client = client
...
function ProjectMemberEntity:get_name()
  return self._name
end


function ProjectMemberEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ProjectMemberEntity.new(self._client, opts)
end
...
function ProjectMemberEntity:mark_deleted()
  self._deleted = true
end


function ProjectMemberEntity:deleted()
  return true == self._deleted
end


function ProjectMemberEntity:data_set(args)
  if args ~= nil then
...
function ProjectMemberEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ProjectMemberEntity:match_set(args)
  if args ~= nil then
...
function ProjectMemberEntity:match_get()
...
function ProjectMemberEntity:stream(action, args, callopts)
...
---@param reqmatch ProjectMemberLoadMatch
---@param ctrl? table
---@return ProjectMember
---@return string? err
function ProjectMemberEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ProjectMemberCreateData
---@param ctrl? table
---@return ProjectMember
---@return string? err
function ProjectMemberEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch ProjectMemberRemoveMatch
---@param ctrl? table
---@return ProjectMember
---@return string? err
function ProjectMemberEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ProjectMemberEntity:_run_op(ctx, post_done)
  local utility = self._utility
