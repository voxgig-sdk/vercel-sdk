-- Vercel SDK ConnectConnectorProjectConnectionList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConnectConnectorProjectConnectionListEntity = {}
ConnectConnectorProjectConnectionListEntity.__index = ConnectConnectorProjectConnectionListEntity


function ConnectConnectorProjectConnectionListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConnectConnectorProjectConnectionListEntity)
  self._name = "connect_connector_project_connection_list"
  self._client = client
...
function ConnectConnectorProjectConnectionListEntity:get_name()
  return self._name
end


function ConnectConnectorProjectConnectionListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConnectConnectorProjectConnectionListEntity.new(self._client, opts)
end
...
function ConnectConnectorProjectConnectionListEntity:mark_deleted()
  self._deleted = true
end


function ConnectConnectorProjectConnectionListEntity:deleted()
  return true == self._deleted
end


function ConnectConnectorProjectConnectionListEntity:data_set(args)
  if args ~= nil then
...
function ConnectConnectorProjectConnectionListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConnectConnectorProjectConnectionListEntity:match_set(args)
  if args ~= nil then
...
function ConnectConnectorProjectConnectionListEntity:match_get()
...
function ConnectConnectorProjectConnectionListEntity:stream(action, args, callopts)
...
---@param reqmatch ConnectConnectorProjectConnectionListListMatch
---@param ctrl? table
---@return ConnectConnectorProjectConnectionList[]
---@return string? err
function ConnectConnectorProjectConnectionListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function ConnectConnectorProjectConnectionListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConnectConnectorProjectConnectionListEntity
