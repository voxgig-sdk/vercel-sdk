...
---@param reqmatch FeatureFlagListMatch
---@param ctrl? table
---@return FeatureFlag[]
---@return string? err
function FeatureFlagEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata FeatureFlagUpdateData
---@param ctrl? table
---@return FeatureFlag
---@return string? err
function FeatureFlagEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
