...
---@param reqdata ArtifactCreateData
---@param ctrl? table
---@return Artifact
---@return string? err
function ArtifactEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ArtifactUpdateData
---@param ctrl? table
---@return Artifact
---@return string? err
function ArtifactEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch ArtifactRemoveMatch
---@param ctrl? table
---@return Artifact
---@return string? err
function ArtifactEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
