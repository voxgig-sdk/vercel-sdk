...
---@param reqmatch SecurityLoadMatch
---@param ctrl? table
---@return Security
---@return string? err
function SecurityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SecurityListMatch
---@param ctrl? table
---@return Security[]
---@return string? err
function SecurityEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SecurityUpdateData
---@param ctrl? table
---@return Security
---@return string? err
function SecurityEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch SecurityRemoveMatch
---@param ctrl? table
---@return Security
---@return string? err
function SecurityEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
