-- Vercel SDK FlagsSdkKeyWithSecret entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local FlagsSdkKeyWithSecretEntity = {}
FlagsSdkKeyWithSecretEntity.__index = FlagsSdkKeyWithSecretEntity


function FlagsSdkKeyWithSecretEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, FlagsSdkKeyWithSecretEntity)
  self._name = "flags_sdk_key_with_secret"
  self._client = client
...
function FlagsSdkKeyWithSecretEntity:get_name()
  return self._name
end


function FlagsSdkKeyWithSecretEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return FlagsSdkKeyWithSecretEntity.new(self._client, opts)
end
...
function FlagsSdkKeyWithSecretEntity:mark_deleted()
  self._deleted = true
end


function FlagsSdkKeyWithSecretEntity:deleted()
  return true == self._deleted
end


function FlagsSdkKeyWithSecretEntity:data_set(args)
  if args ~= nil then
...
function FlagsSdkKeyWithSecretEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function FlagsSdkKeyWithSecretEntity:match_set(args)
  if args ~= nil then
...
function FlagsSdkKeyWithSecretEntity:match_get()
...
function FlagsSdkKeyWithSecretEntity:stream(action, args, callopts)
...
---@param reqdata FlagsSdkKeyWithSecretUpdateData
---@param ctrl? table
---@return FlagsSdkKeyWithSecret
---@return string? err
function FlagsSdkKeyWithSecretEntity:update(reqdata, ctrl)
  local utility = self._utility
...
function FlagsSdkKeyWithSecretEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return FlagsSdkKeyWithSecretEntity
