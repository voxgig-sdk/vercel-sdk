...
local ConnectEntity = {}
ConnectEntity.__index = ConnectEntity


function ConnectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConnectEntity)
  self._name = "connect"
  self._client = client
...
function ConnectEntity:get_name()
  return self._name
end


function ConnectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConnectEntity.new(self._client, opts)
end
...
function ConnectEntity:mark_deleted()
  self._deleted = true
end


function ConnectEntity:deleted()
  return true == self._deleted
end


function ConnectEntity:data_set(args)
  if args ~= nil then
...
function ConnectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConnectEntity:match_set(args)
  if args ~= nil then
...
function ConnectEntity:match_get()
...
function ConnectEntity:stream(action, args, callopts)
...
---@param reqdata ConnectCreateData
---@param ctrl? table
---@return Connect
---@return string? err
function ConnectEntity:create(reqdata, ctrl)
  local utility = self._utility
...
---@param reqmatch ConnectRemoveMatch
---@param ctrl? table
---@return Connect
---@return string? err
function ConnectEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ConnectEntity:_run_op(ctx, post_done)
  local utility = self._utility
