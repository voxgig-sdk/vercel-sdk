...
local PrivateLinkEndpointEntity = {}
PrivateLinkEndpointEntity.__index = PrivateLinkEndpointEntity


function PrivateLinkEndpointEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PrivateLinkEndpointEntity)
  self._name = "private_link_endpoint"
  self._client = client
...
function PrivateLinkEndpointEntity:get_name()
  return self._name
end


function PrivateLinkEndpointEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PrivateLinkEndpointEntity.new(self._client, opts)
end
...
function PrivateLinkEndpointEntity:mark_deleted()
  self._deleted = true
end


function PrivateLinkEndpointEntity:deleted()
  return true == self._deleted
end


function PrivateLinkEndpointEntity:data_set(args)
  if args ~= nil then
...
function PrivateLinkEndpointEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PrivateLinkEndpointEntity:match_set(args)
  if args ~= nil then
...
function PrivateLinkEndpointEntity:match_get()
...
function PrivateLinkEndpointEntity:stream(action, args, callopts)
...
---@param reqmatch PrivateLinkEndpointLoadMatch
---@param ctrl? table
---@return PrivateLinkEndpoint
---@return string? err
function PrivateLinkEndpointEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PrivateLinkEndpointListMatch
---@param ctrl? table
---@return PrivateLinkEndpoint[]
---@return string? err
function PrivateLinkEndpointEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PrivateLinkEndpointCreateData
---@param ctrl? table
---@return PrivateLinkEndpoint
---@return string? err
function PrivateLinkEndpointEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata PrivateLinkEndpointUpdateData
---@param ctrl? table
---@return PrivateLinkEndpoint
---@return string? err
function PrivateLinkEndpointEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function PrivateLinkEndpointEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return PrivateLinkEndpointEntity
