-- Vercel SDK ConnectProjectConnection entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local ConnectProjectConnectionEntity = {}
ConnectProjectConnectionEntity.__index = ConnectProjectConnectionEntity


function ConnectProjectConnectionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConnectProjectConnectionEntity)
  self._name = "connect_project_connection"
  self._client = client
...
function ConnectProjectConnectionEntity:get_name()
  return self._name
end


function ConnectProjectConnectionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConnectProjectConnectionEntity.new(self._client, opts)
end
...
function ConnectProjectConnectionEntity:mark_deleted()
  self._deleted = true
end


function ConnectProjectConnectionEntity:deleted()
  return true == self._deleted
end


function ConnectProjectConnectionEntity:data_set(args)
  if args ~= nil then
...
function ConnectProjectConnectionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConnectProjectConnectionEntity:match_set(args)
  if args ~= nil then
...
function ConnectProjectConnectionEntity:match_get()
...
function ConnectProjectConnectionEntity:stream(action, args, callopts)
...
---@param reqmatch ConnectProjectConnectionLoadMatch
---@param ctrl? table
---@return ConnectProjectConnection
---@return string? err
function ConnectProjectConnectionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ConnectProjectConnectionCreateData
---@param ctrl? table
---@return ConnectProjectConnection
---@return string? err
function ConnectProjectConnectionEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function ConnectProjectConnectionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConnectProjectConnectionEntity
