...
local AiGatewayVirtualModelConfigEntity = {}
AiGatewayVirtualModelConfigEntity.__index = AiGatewayVirtualModelConfigEntity


function AiGatewayVirtualModelConfigEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AiGatewayVirtualModelConfigEntity)
  self._name = "ai_gateway_virtual_model_config"
  self._client = client
...
function AiGatewayVirtualModelConfigEntity:get_name()
  return self._name
end


function AiGatewayVirtualModelConfigEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AiGatewayVirtualModelConfigEntity.new(self._client, opts)
end
...
function AiGatewayVirtualModelConfigEntity:mark_deleted()
  self._deleted = true
end


function AiGatewayVirtualModelConfigEntity:deleted()
  return true == self._deleted
end


function AiGatewayVirtualModelConfigEntity:data_set(args)
  if args ~= nil then
...
function AiGatewayVirtualModelConfigEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AiGatewayVirtualModelConfigEntity:match_set(args)
  if args ~= nil then
...
function AiGatewayVirtualModelConfigEntity:match_get()
...
function AiGatewayVirtualModelConfigEntity:stream(action, args, callopts)
...
---@param reqmatch AiGatewayVirtualModelConfigLoadMatch
---@param ctrl? table
---@return AiGatewayVirtualModelConfig
---@return string? err
function AiGatewayVirtualModelConfigEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata AiGatewayVirtualModelConfigCreateData
---@param ctrl? table
---@return AiGatewayVirtualModelConfig
---@return string? err
function AiGatewayVirtualModelConfigEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AiGatewayVirtualModelConfigUpdateData
---@param ctrl? table
---@return AiGatewayVirtualModelConfig
---@return string? err
function AiGatewayVirtualModelConfigEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function AiGatewayVirtualModelConfigEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return AiGatewayVirtualModelConfigEntity
