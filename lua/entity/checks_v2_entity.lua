...
local ChecksV2Entity = {}
ChecksV2Entity.__index = ChecksV2Entity


function ChecksV2Entity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ChecksV2Entity)
  self._name = "checks_v2"
  self._client = client
...
function ChecksV2Entity:get_name()
  return self._name
end


function ChecksV2Entity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ChecksV2Entity.new(self._client, opts)
end
...
function ChecksV2Entity:mark_deleted()
  self._deleted = true
end


function ChecksV2Entity:deleted()
  return true == self._deleted
end


function ChecksV2Entity:data_set(args)
  if args ~= nil then
...
function ChecksV2Entity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ChecksV2Entity:match_set(args)
  if args ~= nil then
...
function ChecksV2Entity:match_get()
...
function ChecksV2Entity:stream(action, args, callopts)
...
---@param reqmatch ChecksV2LoadMatch
---@param ctrl? table
---@return ChecksV2
---@return string? err
function ChecksV2Entity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ChecksV2ListMatch
---@param ctrl? table
---@return ChecksV2[]
---@return string? err
function ChecksV2Entity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ChecksV2CreateData
---@param ctrl? table
---@return ChecksV2
---@return string? err
function ChecksV2Entity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ChecksV2UpdateData
---@param ctrl? table
---@return ChecksV2
---@return string? err
function ChecksV2Entity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ChecksV2Entity:_run_op(ctx, post_done)
  local utility = self._utility
