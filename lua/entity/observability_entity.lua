...
local ObservabilityEntity = {}
ObservabilityEntity.__index = ObservabilityEntity


function ObservabilityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ObservabilityEntity)
  self._name = "observability"
  self._client = client
...
function ObservabilityEntity:get_name()
  return self._name
end


function ObservabilityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ObservabilityEntity.new(self._client, opts)
end
...
function ObservabilityEntity:mark_deleted()
  self._deleted = true
end


function ObservabilityEntity:deleted()
  return true == self._deleted
end


function ObservabilityEntity:data_set(args)
  if args ~= nil then
...
function ObservabilityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ObservabilityEntity:match_set(args)
  if args ~= nil then
...
function ObservabilityEntity:match_get()
...
function ObservabilityEntity:stream(action, args, callopts)
...
---@param reqmatch ObservabilityListMatch
---@param ctrl? table
---@return Observability[]
---@return string? err
function ObservabilityEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata ObservabilityUpdateData
---@param ctrl? table
---@return Observability
---@return string? err
function ObservabilityEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ObservabilityEntity:_run_op(ctx, post_done)
  local utility = self._utility
