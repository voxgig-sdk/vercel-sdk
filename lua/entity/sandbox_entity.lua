...
local SandboxEntity = {}
SandboxEntity.__index = SandboxEntity


function SandboxEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SandboxEntity)
  self._name = "sandbox"
  self._client = client
...
function SandboxEntity:get_name()
  return self._name
end


function SandboxEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SandboxEntity.new(self._client, opts)
end
...
function SandboxEntity:mark_deleted()
  self._deleted = true
end


function SandboxEntity:deleted()
  return true == self._deleted
end


function SandboxEntity:data_set(args)
  if args ~= nil then
...
function SandboxEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SandboxEntity:match_set(args)
  if args ~= nil then
...
function SandboxEntity:match_get()
...
function SandboxEntity:stream(action, args, callopts)
...
---@param reqmatch SandboxLoadMatch
---@param ctrl? table
---@return Sandbox
---@return string? err
function SandboxEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch SandboxListMatch
---@param ctrl? table
---@return Sandbox[]
---@return string? err
function SandboxEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata SandboxCreateData
---@param ctrl? table
---@return Sandbox
---@return string? err
function SandboxEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata SandboxUpdateData
---@param ctrl? table
---@return Sandbox
---@return string? err
function SandboxEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch SandboxRemoveMatch
---@param ctrl? table
---@return Sandbox
---@return string? err
function SandboxEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function SandboxEntity:_run_op(ctx, post_done)
  local utility = self._utility
