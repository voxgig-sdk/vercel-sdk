...
local AccessGroupEntity = {}
AccessGroupEntity.__index = AccessGroupEntity


function AccessGroupEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, AccessGroupEntity)
  self._name = "access_group"
  self._client = client
...
function AccessGroupEntity:get_name()
  return self._name
end


function AccessGroupEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return AccessGroupEntity.new(self._client, opts)
end
...
function AccessGroupEntity:mark_deleted()
  self._deleted = true
end


function AccessGroupEntity:deleted()
  return true == self._deleted
end


function AccessGroupEntity:data_set(args)
  if args ~= nil then
...
function AccessGroupEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function AccessGroupEntity:match_set(args)
  if args ~= nil then
...
function AccessGroupEntity:match_get()
...
function AccessGroupEntity:stream(action, args, callopts)
...
---@param reqmatch AccessGroupLoadMatch
---@param ctrl? table
---@return AccessGroup
---@return string? err
function AccessGroupEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch AccessGroupListMatch
---@param ctrl? table
---@return AccessGroup[]
---@return string? err
function AccessGroupEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata AccessGroupCreateData
---@param ctrl? table
---@return AccessGroup
---@return string? err
function AccessGroupEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata AccessGroupUpdateData
---@param ctrl? table
---@return AccessGroup
---@return string? err
function AccessGroupEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch AccessGroupRemoveMatch
---@param ctrl? table
---@return AccessGroup
---@return string? err
function AccessGroupEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function AccessGroupEntity:_run_op(ctx, post_done)
  local utility = self._utility
