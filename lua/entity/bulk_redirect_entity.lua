...
local BulkRedirectEntity = {}
BulkRedirectEntity.__index = BulkRedirectEntity


function BulkRedirectEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BulkRedirectEntity)
  self._name = "bulk_redirect"
  self._client = client
...
function BulkRedirectEntity:get_name()
  return self._name
end


function BulkRedirectEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BulkRedirectEntity.new(self._client, opts)
end
...
function BulkRedirectEntity:mark_deleted()
  self._deleted = true
end


function BulkRedirectEntity:deleted()
  return true == self._deleted
end


function BulkRedirectEntity:data_set(args)
  if args ~= nil then
...
function BulkRedirectEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BulkRedirectEntity:match_set(args)
  if args ~= nil then
...
function BulkRedirectEntity:match_get()
...
function BulkRedirectEntity:stream(action, args, callopts)
...
---@param reqmatch BulkRedirectLoadMatch
---@param ctrl? table
---@return BulkRedirect
---@return string? err
function BulkRedirectEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch BulkRedirectListMatch
---@param ctrl? table
---@return BulkRedirect[]
---@return string? err
function BulkRedirectEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata BulkRedirectCreateData
---@param ctrl? table
---@return BulkRedirect
---@return string? err
function BulkRedirectEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata BulkRedirectUpdateData
---@param ctrl? table
---@return BulkRedirect
---@return string? err
function BulkRedirectEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch BulkRedirectRemoveMatch
---@param ctrl? table
---@return BulkRedirect
---@return string? err
function BulkRedirectEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function BulkRedirectEntity:_run_op(ctx, post_done)
  local utility = self._utility
