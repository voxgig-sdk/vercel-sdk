...
local KmsEntity = {}
KmsEntity.__index = KmsEntity


function KmsEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, KmsEntity)
  self._name = "kms"
  self._client = client
...
function KmsEntity:get_name()
  return self._name
end


function KmsEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return KmsEntity.new(self._client, opts)
end
...
function KmsEntity:mark_deleted()
  self._deleted = true
end


function KmsEntity:deleted()
  return true == self._deleted
end


function KmsEntity:data_set(args)
  if args ~= nil then
...
function KmsEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function KmsEntity:match_set(args)
  if args ~= nil then
...
function KmsEntity:stream(action, args, callopts)
...
---@param reqmatch KmsLoadMatch
---@param ctrl? table
---@return Kms
---@return string? err
function KmsEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch KmsListMatch
---@param ctrl? table
---@return Kms[]
---@return string? err
function KmsEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata KmsCreateData
---@param ctrl? table
---@return Kms
---@return string? err
function KmsEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata KmsUpdateData
---@param ctrl? table
---@return Kms
---@return string? err
function KmsEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch KmsRemoveMatch
---@param ctrl? table
---@return Kms
---@return string? err
function KmsEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function KmsEntity:_run_op(ctx, post_done)
  local utility = self._utility
