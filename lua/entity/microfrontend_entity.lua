...
local MicrofrontendEntity = {}
MicrofrontendEntity.__index = MicrofrontendEntity


function MicrofrontendEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MicrofrontendEntity)
  self._name = "microfrontend"
  self._client = client
...
function MicrofrontendEntity:get_name()
  return self._name
end


function MicrofrontendEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MicrofrontendEntity.new(self._client, opts)
end
...
function MicrofrontendEntity:mark_deleted()
  self._deleted = true
end


function MicrofrontendEntity:deleted()
  return true == self._deleted
end


function MicrofrontendEntity:data_set(args)
  if args ~= nil then
...
function MicrofrontendEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MicrofrontendEntity:match_set(args)
  if args ~= nil then
...
function MicrofrontendEntity:match_get()
...
function MicrofrontendEntity:stream(action, args, callopts)
...
---@param reqmatch MicrofrontendLoadMatch
---@param ctrl? table
---@return Microfrontend
---@return string? err
function MicrofrontendEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch MicrofrontendListMatch
---@param ctrl? table
---@return Microfrontend[]
---@return string? err
function MicrofrontendEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata MicrofrontendCreateData
---@param ctrl? table
---@return Microfrontend
---@return string? err
function MicrofrontendEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function MicrofrontendEntity:_run_op(ctx, post_done)
  local utility = self._utility
