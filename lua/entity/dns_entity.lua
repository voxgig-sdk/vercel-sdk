...
---@param reqdata DnsCreateData
---@param ctrl? table
---@return Dns
---@return string? err
function DnsEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata DnsUpdateData
---@param ctrl? table
---@return Dns
---@return string? err
function DnsEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
---@param reqmatch DnsRemoveMatch
---@param ctrl? table
---@return Dns
---@return string? err
function DnsEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
