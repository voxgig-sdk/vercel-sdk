-- Vercel SDK VcrRepositoryPermissionList entity

local vs = require("utility.struct.struct")
local helpers = require("core.helpers")

local VcrRepositoryPermissionListEntity = {}
VcrRepositoryPermissionListEntity.__index = VcrRepositoryPermissionListEntity


function VcrRepositoryPermissionListEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VcrRepositoryPermissionListEntity)
  self._name = "vcr_repository_permission_list"
  self._client = client
...
function VcrRepositoryPermissionListEntity:get_name()
  return self._name
end


function VcrRepositoryPermissionListEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VcrRepositoryPermissionListEntity.new(self._client, opts)
end
...
function VcrRepositoryPermissionListEntity:mark_deleted()
  self._deleted = true
end


function VcrRepositoryPermissionListEntity:deleted()
  return true == self._deleted
end


function VcrRepositoryPermissionListEntity:data_set(args)
  if args ~= nil then
...
function VcrRepositoryPermissionListEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VcrRepositoryPermissionListEntity:match_set(args)
  if args ~= nil then
...
function VcrRepositoryPermissionListEntity:match_get()
...
function VcrRepositoryPermissionListEntity:stream(action, args, callopts)
...
---@param reqmatch VcrRepositoryPermissionListListMatch
---@param ctrl? table
---@return VcrRepositoryPermissionList[]
---@return string? err
function VcrRepositoryPermissionListEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function VcrRepositoryPermissionListEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return VcrRepositoryPermissionListEntity
