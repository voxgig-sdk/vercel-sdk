...
describe("ApiAiGatewayDirect", function()
  it("should direct-load-api_ai_gateway", function()
    local setup = api_ai_gateway_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-api_ai_gateway", setup.live and "live" or "unit")
...
function api_ai_gateway_direct_setup(mockres)
