...
describe("ProjectMemberDirect", function()
  it("should direct-load-project_member", function()
    local setup = project_member_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-project_member", setup.live and "live" or "unit")
...
function project_member_direct_setup(mockres)
