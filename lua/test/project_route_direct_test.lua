...
describe("ProjectRouteDirect", function()
  it("should direct-list-project_route", function()
    local setup = project_route_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-project_route", setup.live and "live" or "unit")
  ...
  it("should direct-load-project_route", function()
    local setup = project_route_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-project_route", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function project_route_direct_setup(mockres)
