...
describe("ConnectConnectorDirect", function()
  it("should direct-load-connect_connector", function()
    local setup = connect_connector_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-connect_connector", setup.live and "live" or "unit")
...
function connect_connector_direct_setup(mockres)
