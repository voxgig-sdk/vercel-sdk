...
describe("TldNameDirect", function()
  it("should direct-list-tld_name", function()
    local setup = tld_name_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-tld_name", setup.live and "live" or "unit")
...
function tld_name_direct_setup(mockres)
