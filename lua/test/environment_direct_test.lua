...
describe("EnvironmentDirect", function()
  it("should direct-list-environment", function()
    local setup = environment_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-environment", setup.live and "live" or "unit")
