...
describe("ListEventTypeDirect", function()
  it("should direct-list-list_event_type", function()
    local setup = list_event_type_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-list_event_type", setup.live and "live" or "unit")
...
function list_event_type_direct_setup(mockres)
