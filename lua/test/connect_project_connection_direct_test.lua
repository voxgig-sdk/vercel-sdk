-- ConnectProjectConnection direct test
...
describe("ConnectProjectConnectionDirect", function()
  it("should direct-load-connect_project_connection", function()
    local setup = connect_project_connection_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-connect_project_connection", setup.live and "live" or "unit")
...
function connect_project_connection_direct_setup(mockres)
