...
describe("FlagDirect", function()
  it("should direct-load-flag", function()
    local setup = flag_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-flag", setup.live and "live" or "unit")
...
function flag_direct_setup(mockres)
