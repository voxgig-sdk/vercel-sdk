-- AiGatewayVirtualModelConfig direct test
...
describe("AiGatewayVirtualModelConfigDirect", function()
  it("should direct-load-ai_gateway_virtual_model_config", function()
    local setup = ai_gateway_virtual_model_config_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-ai_gateway_virtual_model_config", setup.live and "live" or "unit")
...
function ai_gateway_virtual_model_config_direct_setup(mockres)
