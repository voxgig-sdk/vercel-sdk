...
describe("VcrImageListDirect", function()
  it("should direct-list-vcr_image_list", function()
    local setup = vcr_image_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-vcr_image_list", setup.live and "live" or "unit")
...
function vcr_image_list_direct_setup(mockres)
