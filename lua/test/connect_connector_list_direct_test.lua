-- ConnectConnectorList direct test
...
describe("ConnectConnectorListDirect", function()
  it("should direct-list-connect_connector_list", function()
    local setup = connect_connector_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-connect_connector_list", setup.live and "live" or "unit")
...
function connect_connector_list_direct_setup(mockres)
