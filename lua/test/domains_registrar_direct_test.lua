...
describe("DomainsRegistrarDirect", function()
  it("should direct-load-domains_registrar", function()
    local setup = domains_registrar_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-domains_registrar", setup.live and "live" or "unit")
...
function domains_registrar_direct_setup(mockres)
