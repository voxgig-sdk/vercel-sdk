...
describe("AccessGroupDirect", function()
  it("should direct-list-access_group", function()
    local setup = access_group_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-access_group", setup.live and "live" or "unit")
  ...
  it("should direct-load-access_group", function()
    local setup = access_group_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-access_group", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function access_group_direct_setup(mockres)
