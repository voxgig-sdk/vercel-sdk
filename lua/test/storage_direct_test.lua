...
describe("StorageDirect", function()
  it("should direct-load-storage", function()
    local setup = storage_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-storage", setup.live and "live" or "unit")
...
function storage_direct_setup(mockres)
