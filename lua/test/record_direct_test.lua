...
describe("RecordDirect", function()
  it("should direct-load-record", function()
    local setup = record_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-record", setup.live and "live" or "unit")
