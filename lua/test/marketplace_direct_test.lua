...
describe("MarketplaceDirect", function()
  it("should direct-list-marketplace", function()
    local setup = marketplace_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-marketplace", setup.live and "live" or "unit")
  ...
  it("should direct-load-marketplace", function()
    local setup = marketplace_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-marketplace", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function marketplace_direct_setup(mockres)
