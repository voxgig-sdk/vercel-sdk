...
describe("DrainDirect", function()
  it("should direct-load-drain", function()
    local setup = drain_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-drain", setup.live and "live" or "unit")
...
function drain_direct_setup(mockres)
