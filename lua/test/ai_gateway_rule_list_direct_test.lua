...
describe("AiGatewayRuleListDirect", function()
  it("should direct-list-ai_gateway_rule_list", function()
    local setup = ai_gateway_rule_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-ai_gateway_rule_list", setup.live and "live" or "unit")
...
function ai_gateway_rule_list_direct_setup(mockres)
