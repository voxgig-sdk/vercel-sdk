...
describe("ObservabilityDirect", function()
  it("should direct-list-observability", function()
    local setup = observability_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-observability", setup.live and "live" or "unit")
...
function observability_direct_setup(mockres)
