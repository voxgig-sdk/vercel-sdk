...
describe("VcrRepositoryListDirect", function()
  it("should direct-list-vcr_repository_list", function()
    local setup = vcr_repository_list_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-vcr_repository_list", setup.live and "live" or "unit")
...
function vcr_repository_list_direct_setup(mockres)
