...
describe("GlobalConfigTokenDirect", function()
  it("should direct-load-global_config_token", function()
    local setup = global_config_token_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-global_config_token", setup.live and "live" or "unit")
...
function global_config_token_direct_setup(mockres)
