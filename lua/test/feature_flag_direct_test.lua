...
describe("FeatureFlagDirect", function()
  it("should direct-list-feature_flag", function()
    local setup = feature_flag_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-feature_flag", setup.live and "live" or "unit")
