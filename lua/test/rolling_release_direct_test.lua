...
describe("RollingReleaseDirect", function()
  it("should direct-load-rolling_release", function()
    local setup = rolling_release_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-rolling_release", setup.live and "live" or "unit")
...
function rolling_release_direct_setup(mockres)
