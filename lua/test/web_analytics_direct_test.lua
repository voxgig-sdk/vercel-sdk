...
describe("WebAnalyticsDirect", function()
  it("should direct-load-web_analytics", function()
    local setup = web_analytics_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-web_analytics", setup.live and "live" or "unit")
...
function web_analytics_direct_setup(mockres)
