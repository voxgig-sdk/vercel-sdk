...
describe("BillingEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set VERCEL_TEST_BILLING_ENTID JSON to run live")
      return
    end
...
function billing_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("VERCEL_TEST_BILLING_ENTID")
