...
class AccessGroupEntity extends VercelEntityBase {
  ...
  /**
   * @param {AccessGroupLoadMatch} [reqmatch]
   * @param {Object} [ctrl]
  ...
  /**
   * @param {AccessGroupListMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<AccessGroup[]>}
   */
  ...
  /**
   * @param {AccessGroupCreateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<AccessGroup>}
   */
  ...
  /**
   * @param {AccessGroupUpdateData} [reqdata]
   * @param {Object} [ctrl]
   * @returns {Promise<AccessGroup>}
   */
  ...
  /**
   * @param {AccessGroupRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<AccessGroup>}
   */
