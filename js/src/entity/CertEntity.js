...
class CertEntity extends VercelEntityBase {
  ...
  /**
   * @param {CertRemoveMatch} [reqmatch]
   * @param {Object} [ctrl]
   * @returns {Promise<Cert>}
   */
