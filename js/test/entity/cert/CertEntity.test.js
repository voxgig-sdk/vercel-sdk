...
describe('CertEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    assert(cert_ref01_resdata_up0[cert_ref01_markdef_up0.name] === cert_ref01_markdef_up0.value)
    ...
    // REMOVE
    const cert_ref01_match_rm0 = {}
    cert_ref01_match_rm0.id = cert_ref01_data.id
