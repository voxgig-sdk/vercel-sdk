...
describe('ConnectProjectConnectionEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    assert(null != connect_project_connection_ref01_data)


    // LOAD
    const connect_project_connection_ref01_match_dt0 = {}
    const connect_project_connection_ref01_data_dt0 = (await connect_project_connection_ref01_ent.load(connect_project_connection_ref01_match_dt0)).data()
    assert(null != connect_project_connection_ref01_data_dt0)
...
function basicSetup(extra) {
  ...
  const entityDataFile =
    Path.resolve(__dirname,
      '../../../../.sdk/test/entity/connect_project_connection/ConnectProjectConnectionTestData.json')
