...
describe('DnsEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    assert(dns_ref01_resdata_up0[dns_ref01_markdef_up0.name] === dns_ref01_markdef_up0.value)
    ...
    // REMOVE
    const dns_ref01_match_rm0 = {}
    dns_ref01_match_rm0.id = dns_ref01_data.id
