...
describe('AiGatewayVirtualModelConfigListEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    let ai_gateway_virtual_model_config_list_ref01_data = Object.values(setup.data.existing.ai_gateway_virtual_model_config_list)[0] as any

    // LIST
    const ai_gateway_virtual_model_config_list_ref01_ent = client.AiGatewayVirtualModelConfigList()
    const ai_gateway_virtual_model_config_list_ref01_match: any = {}

    const ai_gateway_virtual_model_config_list_ref01_list = (await ai_gateway_virtual_model_config_list_ref01_ent.list(ai_gateway_virtual_model_config_list_ref01_match)).map((e: any) => e.data())
...
function basicSetup(extra?: any) {
  ...
  const entityDataFile =
    Path.resolve(__dirname, 
      '../../../../.sdk/test/entity/ai_gateway_virtual_model_config_list/AiGatewayVirtualModelConfigListTestData.json')
