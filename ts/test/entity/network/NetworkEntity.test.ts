...
describe('NetworkEntity', async () => {
  ...
  test('basic', async (t) => {
    ...
    // UPDATE
    const network_ref01_data_up0: any = {}
    ...
    ;(network_ref01_data_up0 as any)[network_ref01_markdef_up0.name] = network_ref01_markdef_up0.value
    ...
    assert((network_ref01_resdata_up0 as any)[network_ref01_markdef_up0.name] === network_ref01_markdef_up0.value)
    ...
    // REMOVE
    const network_ref01_match_rm0: any = { id: network_ref01_data.id }
    await network_ref01_ent.remove(network_ref01_match_rm0)
  

    // LIST
    const network_ref01_match_rt0: any = {}

    const network_ref01_list_rt0 = (await network_ref01_ent.list(network_ref01_match_rt0)).map((e: any) => e.data())
