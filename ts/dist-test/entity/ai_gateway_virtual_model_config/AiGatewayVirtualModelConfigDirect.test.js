...
(0, node_test_1.describe)('AiGatewayVirtualModelConfigDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-ai_gateway_virtual_model_config', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-ai_gateway_virtual_model_config', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_AI_GATEWAY_VIRTUAL_MODEL_CONFIG_ENTID'];
...
//# sourceMappingURL=AiGatewayVirtualModelConfigDirect.test.js.map