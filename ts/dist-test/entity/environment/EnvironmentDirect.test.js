...
(0, node_test_1.describe)('EnvironmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-environment', async (t) => {
        ...
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-environment', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["environment_slug_or01", "project01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.environment_slug_or_id ?? listArr[0]?.id;
            if (null == candidateId) {
                throw new Error('Live load blocked: discovery returned no usable identity');
            }
            params.environment_slug_or_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-environment', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-environment', setup.live))
            return;
