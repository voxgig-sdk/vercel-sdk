...
(0, node_test_1.describe)('TldNameDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-tld_name', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-tld_name', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_TLD_NAME_ENTID'];
...
//# sourceMappingURL=TldNameDirect.test.js.map