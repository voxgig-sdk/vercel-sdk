...
(0, node_test_1.describe)('MarketplaceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-marketplace', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-marketplace', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["installation01", "invoice01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.installation_id ?? listArr[0]?.id;
            if (null == candidateId) {
                throw new Error('Live load blocked: discovery returned no usable identity');
            }
            params.installation_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-marketplace', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-marketplace', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_MARKETPLACE_ENTID'];
...
//# sourceMappingURL=MarketplaceDirect.test.js.map