...
(0, node_test_1.describe)('GlobalConfigTokenDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-global_config_token', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-global_config_token', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["global_config_id01", "id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_GLOBAL_CONFIG_TOKEN_ENTID'];
...
//# sourceMappingURL=GlobalConfigTokenDirect.test.js.map