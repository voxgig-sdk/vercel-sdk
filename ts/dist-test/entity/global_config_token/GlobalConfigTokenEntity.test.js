...
(0, node_test_1.describe)('GlobalConfigTokenEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'global_config_token.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(global_config_token_ref01_data_dt0.id === global_config_token_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/global_config_token/GlobalConfigTokenTestData.json');
    ...
    let idmap = transform(['global_config_token01', 'global_config_token02', 'global_config_token03', 'global_config01', 'global_config02', 'global_config03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=GlobalConfigTokenEntity.test.js.map