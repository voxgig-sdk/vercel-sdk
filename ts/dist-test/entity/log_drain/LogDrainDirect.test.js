...
(0, node_test_1.describe)('LogDrainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-log_drain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-log_drain', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-log_drain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-log_drain', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_LOG_DRAIN_ENTID'];
...
//# sourceMappingURL=LogDrainDirect.test.js.map