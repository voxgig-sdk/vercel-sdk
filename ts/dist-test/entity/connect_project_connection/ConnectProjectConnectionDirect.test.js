...
(0, node_test_1.describe)('ConnectProjectConnectionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-connect_project_connection', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-connect_project_connection', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["connector_id01", "project_id01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_CONNECT_PROJECT_CONNECTION_ENTID'];
...
//# sourceMappingURL=ConnectProjectConnectionDirect.test.js.map