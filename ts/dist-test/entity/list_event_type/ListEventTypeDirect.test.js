...
(0, node_test_1.describe)('ListEventTypeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-list_event_type', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-list_event_type', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_LIST_EVENT_TYPE_ENTID'];
...
//# sourceMappingURL=ListEventTypeDirect.test.js.map