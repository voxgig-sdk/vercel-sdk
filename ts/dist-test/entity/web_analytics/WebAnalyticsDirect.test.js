...
(0, node_test_1.describe)('WebAnalyticsDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-web_analytics', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-web_analytics', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_WEB_ANALYTICS_ENTID'];
...
//# sourceMappingURL=WebAnalyticsDirect.test.js.map