...
(0, node_test_1.describe)('ToggleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != toggle_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/toggle/ToggleTestData.json');
    ...
    let idmap = transform(['toggle01', 'toggle02', 'toggle03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ToggleEntity.test.js.map