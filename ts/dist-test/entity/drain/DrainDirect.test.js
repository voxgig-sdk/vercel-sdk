...
(0, node_test_1.describe)('DrainDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-drain', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-drain', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_DRAIN_ENTID'];
...
//# sourceMappingURL=DrainDirect.test.js.map