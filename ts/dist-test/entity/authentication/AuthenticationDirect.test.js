...
(0, node_test_1.describe)('AuthenticationDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-authentication', async (t) => {
        ...
        const query = {};
        if (setup.live) {
            params.token_id = "5d9f2ebd38ddca62e5d51e9c1704c72530bdc8bfdd41e782a6687c48399e8391";
        }
        else {
            params.token_id = 'direct01';
        }
        const result = await client.direct({
            path: 'v5/user/tokens/{token_id}',
            method: 'GET',
            params,
            query,
        });
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_AUTHENTICATION_ENTID'];
