...
(0, node_test_1.describe)('StorageEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != storage_ref01_data.id);
        // LOAD
        ...
        (0, node_assert_1.default)(storage_ref01_data_dt0.id === storage_ref01_data.id);
        // REMOVE
        const storage_ref01_match_rm0 = { id: storage_ref01_data.id };
...
function basicSetup(extra) {
    ...
    let idmap = transform(['storage01', 'storage02', 'storage03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
