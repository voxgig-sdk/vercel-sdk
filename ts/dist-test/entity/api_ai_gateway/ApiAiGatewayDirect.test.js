...
(0, node_test_1.describe)('ApiAiGatewayDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-api_ai_gateway', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-api_ai_gateway', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_API_AI_GATEWAY_ENTID'];
...
//# sourceMappingURL=ApiAiGatewayDirect.test.js.map