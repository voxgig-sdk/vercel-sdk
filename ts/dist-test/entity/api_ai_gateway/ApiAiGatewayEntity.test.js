...
(0, node_test_1.describe)('ApiAiGatewayEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'api_ai_gateway.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != api_ai_gateway_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/api_ai_gateway/ApiAiGatewayTestData.json');
    ...
    let idmap = transform(['api_ai_gateway01', 'api_ai_gateway02', 'api_ai_gateway03', 'virtual_model_config01', 'virtual_model_config02', 'virtual_model_config03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ApiAiGatewayEntity.test.js.map