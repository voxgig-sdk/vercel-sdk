...
function basicSetup(extra) {
    ...
    let idmap = transform(['file01', 'file02', 'file03', 'deployment01', 'deployment02', 'deployment03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
