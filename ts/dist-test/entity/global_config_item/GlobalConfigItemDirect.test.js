...
(0, node_test_1.describe)('GlobalConfigItemDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-global_config_item', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-global_config_item', setup.live))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['global_config_item01'],
                },
            });
    ...
    (0, node_test_1.test)('direct-list-global_config_item', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-global_config_item', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["global_config_item01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_GLOBAL_CONFIG_ITEM_ENTID'];
...
//# sourceMappingURL=GlobalConfigItemDirect.test.js.map