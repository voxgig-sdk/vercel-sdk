...
(0, node_test_1.describe)('AccessGroupDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-access_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-access_group', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-access_group', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-access_group', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_ACCESS_GROUP_ENTID'];
...
//# sourceMappingURL=AccessGroupDirect.test.js.map