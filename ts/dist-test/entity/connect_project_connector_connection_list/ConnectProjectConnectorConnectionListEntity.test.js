...
(0, node_test_1.describe)('ConnectProjectConnectorConnectionListEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'connect_project_connector_connection_list.' + op, live))
                return;
        }
        ...
        let connect_project_connector_connection_list_ref01_data = Object.values(setup.data.existing.connect_project_connector_connection_list)[0];
        // LIST
        const connect_project_connector_connection_list_ref01_ent = client.ConnectProjectConnectorConnectionList();
        const connect_project_connector_connection_list_ref01_match = {};
        connect_project_connector_connection_list_ref01_match['project_id'] = setup.idmap['project01'];
        const connect_project_connector_connection_list_ref01_list = (await connect_project_connector_connection_list_ref01_ent.list(connect_project_connector_connection_list_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/connect_project_connector_connection_list/ConnectProjectConnectorConnectionListTestData.json');
    ...
    let idmap = transform(['connect_project_connector_connection_list01', 'connect_project_connector_connection_list02', 'connect_project_connector_connection_list03', 'project01', 'project02', 'project03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConnectProjectConnectorConnectionListEntity.test.js.map