...
(0, node_test_1.describe)('ConnectProjectConnectorConnectionListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-connect_project_connector_connection_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-connect_project_connector_connection_list', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_CONNECT_PROJECT_CONNECTOR_CONNECTION_LIST_ENTID'];
...
//# sourceMappingURL=ConnectProjectConnectorConnectionListDirect.test.js.map