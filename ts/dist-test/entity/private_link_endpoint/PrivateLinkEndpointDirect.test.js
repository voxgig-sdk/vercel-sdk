...
(0, node_test_1.describe)('PrivateLinkEndpointDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-private_link_endpoint', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-private_link_endpoint', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-private_link_endpoint', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-private_link_endpoint', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_PRIVATE_LINK_ENDPOINT_ENTID'];
...
//# sourceMappingURL=PrivateLinkEndpointDirect.test.js.map