...
(0, node_test_1.describe)('ObservabilityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-observability', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-observability', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_OBSERVABILITY_ENTID'];
...
//# sourceMappingURL=ObservabilityDirect.test.js.map