...
(0, node_test_1.describe)('ConnectConnectorProjectConnectionListDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-connect_connector_project_connection_list', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-connect_connector_project_connection_list', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["connector01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_CONNECT_CONNECTOR_PROJECT_CONNECTION_LIST_ENTID'];
...
//# sourceMappingURL=ConnectConnectorProjectConnectionListDirect.test.js.map