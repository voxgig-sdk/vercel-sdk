...
(0, node_test_1.describe)('MicrofrontendDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-microfrontend', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-microfrontend', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-microfrontend', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-microfrontend', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_MICROFRONTEND_ENTID'];
...
//# sourceMappingURL=MicrofrontendDirect.test.js.map