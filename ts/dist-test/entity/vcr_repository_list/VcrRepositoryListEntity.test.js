...
(0, node_test_1.describe)('VcrRepositoryListEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/vcr_repository_list/VcrRepositoryListTestData.json');
    ...
    let idmap = transform(['vcr_repository_list01', 'vcr_repository_list02', 'vcr_repository_list03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=VcrRepositoryListEntity.test.js.map