...
(0, node_test_1.describe)('DomainsRegistrarDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-domains_registrar', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-domains_registrar', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_DOMAINS_REGISTRAR_ENTID'];
...
//# sourceMappingURL=DomainsRegistrarDirect.test.js.map