...
(0, node_test_1.describe)('RollingReleaseDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-rolling_release', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-rolling_release', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_ROLLING_RELEASE_ENTID'];
...
//# sourceMappingURL=RollingReleaseDirect.test.js.map