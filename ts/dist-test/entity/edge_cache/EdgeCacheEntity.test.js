...
(0, node_test_1.describe)('EdgeCacheEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'edge_cache.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != edge_cache_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/edge_cache/EdgeCacheTestData.json');
    ...
    let idmap = transform(['edge_cache01', 'edge_cache02', 'edge_cache03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=EdgeCacheEntity.test.js.map