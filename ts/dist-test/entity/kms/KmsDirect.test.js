...
(0, node_test_1.describe)('KmsDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-kms', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-kms', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["issuer01"]))
            return;
        ...
        if (setup.live) {
            ...
            const candidateId = listArr[0]?.issuer_id ?? listArr[0]?.id;
            if (null == candidateId) {
                throw new Error('Live load blocked: discovery returned no usable identity');
            }
            params.issuer_id = candidateId;
    ...
    (0, node_test_1.test)('direct-list-kms', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-kms', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['VERCEL_TEST_KMS_ENTID'];
...
//# sourceMappingURL=KmsDirect.test.js.map