...
(0, node_test_1.describe)('GlobalConfigDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-global_config', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-global_config', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["edge_config_backup_version01"]))
            return;
        ...
        if (setup.live) {
            const listResult = await client.direct({
                ...
                method: 'GET',
                params: {
                    id: setup.idmap['global_config01'],
                },
            });
    ...
    (0, node_test_1.test)('direct-list-global_config', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-global_config', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["global_config01"]))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.VercelSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.VERCEL_APIKEY,
        }));
        let idmap = env['VERCEL_TEST_GLOBAL_CONFIG_ENTID'];
...
//# sourceMappingURL=GlobalConfigDirect.test.js.map