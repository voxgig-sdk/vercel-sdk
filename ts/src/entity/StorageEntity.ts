...
class StorageEntity extends VercelEntityBase<Storage> {
  ...
  make(this: StorageEntity) {
    return new StorageEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: StorageLoadMatch, ctrl?: Control): Promise<StorageEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Storage> return stays clean under strict null checks.
  ...
  async create(this: any, reqdata?: StorageCreateData, ctrl?: Control): Promise<StorageEntity> {
  ...
  async remove(
    this: any, reqmatch?: StorageRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<StorageEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
