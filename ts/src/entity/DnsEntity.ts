...
class DnsEntity extends VercelEntityBase<Dns> {
  ...
  async create(this: any, reqdata?: DnsCreateData, ctrl?: Control): Promise<DnsEntity> {
  ...
  async update(this: any, reqdata?: DnsUpdateData, ctrl?: Control): Promise<DnsEntity> {
  ...
  async remove(
    this: any, reqmatch?: DnsRemoveMatch, ctrl?: Control,
  ): Promise<DnsEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<DnsEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
