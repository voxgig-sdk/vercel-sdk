...
class DomainEntity extends VercelEntityBase<Domain> {
  ...
  async create(this: any, reqdata?: DomainCreateData, ctrl?: Control): Promise<DomainEntity> {
  ...
  async update(this: any, reqdata?: DomainUpdateData, ctrl?: Control): Promise<DomainEntity> {
  ...
  async remove(
    this: any, reqmatch?: DomainRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<DomainEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
