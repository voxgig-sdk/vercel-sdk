...
import type {
  AiGateway,
  AiGatewayRemoveMatch,
} from '../VercelTypes'

// TODO: needs Entity superclass
class AiGatewayEntity extends VercelEntityBase<AiGateway> {

  constructor(client: VercelSDK, entopts: any) {
    super(client, entopts)
    this.name = 'ai_gateway'
    this.name_ = 'ai_gateway'
    this.Name = 'AiGateway'
  }


  make(this: AiGatewayEntity) {
    return new AiGatewayEntity(this._client, this.entopts())
  }
  ...
  async remove(
    this: any, reqmatch?: AiGatewayRemoveMatch, ctrl?: Control,
  ): Promise<AiGatewayEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<AiGatewayEntity> return stays clean under strict null checks.
