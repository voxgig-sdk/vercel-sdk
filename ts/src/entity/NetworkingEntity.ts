...
import type {
  Networking,
  NetworkingUpdateData,
  NetworkingRemoveMatch,
} from '../VercelTypes'

// TODO: needs Entity superclass
class NetworkingEntity extends VercelEntityBase<Networking> {

  constructor(client: VercelSDK, entopts: any) {
    super(client, entopts)
    this.name = 'networking'
    this.name_ = 'networking'
    this.Name = 'Networking'
  }


  make(this: NetworkingEntity) {
    return new NetworkingEntity(this._client, this.entopts())
  }
  ...
  async update(this: any, reqdata?: NetworkingUpdateData, ctrl?: Control): Promise<NetworkingEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Networking> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: NetworkingRemoveMatch, ctrl?: Control,
  ): Promise<NetworkingEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<NetworkingEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
