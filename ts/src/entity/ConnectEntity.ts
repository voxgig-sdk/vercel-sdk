...
class ConnectEntity extends VercelEntityBase<Connect> {
  ...
  make(this: ConnectEntity) {
    return new ConnectEntity(this._client, this.entopts())
  }
  ...
  async create(this: any, reqdata?: ConnectCreateData, ctrl?: Control): Promise<ConnectEntity> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Connect> return stays clean under strict null checks.
  ...
  async remove(
    this: any, reqmatch?: ConnectRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ConnectEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
